...
public class Model40highcube extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].setRotationPoint(-17.5F, 4F, -1F);

		bodyModel[1].addBox(0F, 0F, 0F, 55, 1, 22, 0F); // Box 1
		bodyModel[1].setRotationPoint(-27.5F, 1F, -11F);

		bodyModel[2].addBox(0F, 0F, 0F, 20, 25, 1, 0F); // Box 3
		bodyModel[2].setRotationPoint(-27.5F, -24F, -11F);

		bodyModel[3].addBox(0F, 0F, 0F, 20, 25, 1, 0F); // Box 5
		bodyModel[3].setRotationPoint(7.5F, -24F, -11F);

		bodyModel[4].addBox(0F, 0F, 0F, 1, 25, 20, 0F); // Box 8
		bodyModel[4].setRotationPoint(-27.5F, -24F, -10F);

		bodyModel[5].addBox(0F, 0F, 0F, 1, 25, 20, 0F); // Box 9
		bodyModel[5].setRotationPoint(26.5F, -24F, -10F);
		...
		bodyModel[6].setRotationPoint(-27.5F, -25F, -11F);
		...
		bodyModel[7].setRotationPoint(-21.5F, 2F, 11F);

		bodyModel[8].addBox(0F, 0F, 0F, 2, 2, 8, 0F); // Box 42
		bodyModel[8].setRotationPoint(-17.5F, 1.8F, -10F);

		bodyModel[9].addBox(0F, 0F, 0F, 2, 2, 8, 0F); // Box 43
		bodyModel[9].setRotationPoint(-17.5F, 1.8F, 2F);

		bodyModel[10].addBox(0F, 0F, 0F, 2, 2, 8, 0F); // Box 44
		bodyModel[10].setRotationPoint(15.5F, 1.8F, -10F);

		bodyModel[11].addBox(0F, 0F, 0F, 2, 2, 8, 0F); // Box 45
		bodyModel[11].setRotationPoint(15.5F, 1.8F, 2F);

		bodyModel[12].addBox(0F, 0F, 0F, 0, 3, 3, 0F); // Box 72
		bodyModel[12].setRotationPoint(-29.01F, -6F, 2F);
		...
		bodyModel[13].setRotationPoint(-7.5F, -24F, -11.5F);
		...
		bodyModel[14].setRotationPoint(-28.5F, -6F, 2F);

		bodyModel[15].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 87
		bodyModel[15].setRotationPoint(-29F, -5F, 3F);

		bodyModel[16].addBox(0F, 0F, 0F, 20, 25, 1, 0F); // Box 104
		bodyModel[16].setRotationPoint(7.5F, -24F, 10F);

		bodyModel[17].addBox(0F, 0F, 0F, 20, 25, 1, 0F); // Box 105
		bodyModel[17].setRotationPoint(-27.5F, -24F, 10F);
		...
		bodyModel[18].setRotationPoint(-20.5F, -25F, 10.5F);
		...
		bodyModel[19].setRotationPoint(-7.5F, -24F, 10.5F);
		...
		bodyModel[20].setRotationPoint(-12F, 3F, 11F);

		bodyModel[21].addBox(0F, 0F, 0F, 3, 2, 3, 0F); // Box 0
		bodyModel[21].setRotationPoint(30.5F, 2F, -1.5F);

		bodyModel[22].addBox(0F, 0F, 0F, 61, 2, 5, 0F); // Box 0
		bodyModel[22].setRotationPoint(-30.5F, 2F, -2.5F);

		bodyModel[23].addBox(0F, 0F, 0F, 3, 2, 3, 0F); // Box 0
		bodyModel[23].setRotationPoint(-33.5F, 2F, -1.5F);

		bodyModel[24].addBox(0F, 0F, 0F, 2, 2, 2, 0F); // Box 0
		bodyModel[24].setRotationPoint(15.5F, 4F, -1F);
		...
		bodyModel[25].setRotationPoint(-21.5F, 2F, -11F);
		...
		bodyModel[26].setRotationPoint(-12F, 3F, -11F);
		...
		bodyModel[27].setRotationPoint(-20.5F, 1F, 10.5F);
		...
		bodyModel[28].setRotationPoint(-7.5F, -25F, -11.5F);
		...
		bodyModel[29].setRotationPoint(-7.5F, 1F, -11.5F);
		...
		bodyModel[30].setRotationPoint(-27.5F, 2F, 11F);
		...
		bodyModel[31].setRotationPoint(-27.5F, 2F, -11F);
		...
		bodyModel[32].setRotationPoint(23.5F, 2F, 11F);
		...
		bodyModel[33].setRotationPoint(23.5F, 2F, -11F);
		...
		bodyModel[34].setRotationPoint(-28.5F, -8F, 10F);
		...
		bodyModel[35].setRotationPoint(-28.5F, -8F, 6F);
		...
		bodyModel[36].setRotationPoint(-28.5F, 1F, 6F);
		...
		bodyModel[37].setRotationPoint(-28.5F, -2F, 6F);
		...
		bodyModel[38].setRotationPoint(-28.5F, -5F, 6F);
		...
		bodyModel[39].setRotationPoint(-28.5F, -8F, 6F);
		...
		bodyModel[40].setRotationPoint(-28.5F, -8F, -6F);
		...
		bodyModel[41].setRotationPoint(-28.5F, -8F, -10F);
		...
		bodyModel[42].setRotationPoint(-28.5F, 1F, -10F);
		...
		bodyModel[43].setRotationPoint(-28.5F, -2F, -10F);
		...
		bodyModel[44].setRotationPoint(-28.5F, -5F, -10F);
		...
		bodyModel[45].setRotationPoint(-28.5F, -8F, -10F);
		...
		bodyModel[46].setRotationPoint(27.5F, -8F, 10F);
		...
		bodyModel[47].setRotationPoint(27.5F, -8F, 6F);
		...
		bodyModel[48].setRotationPoint(28.5F, 1F, 6F);
		...
		bodyModel[49].setRotationPoint(28.5F, -2F, 6F);
		...
		bodyModel[51].setRotationPoint(28.5F, -8F, 6F);
		...
		bodyModel[52].setRotationPoint(27.5F, -8F, -6F);
		...
		bodyModel[53].setRotationPoint(27.5F, -8F, -10F);
		...
		bodyModel[54].setRotationPoint(28.5F, 1F, -10F);
		...
		bodyModel[55].setRotationPoint(28.5F, -2F, -10F);
		...
		bodyModel[56].setRotationPoint(28.5F, -5F, -10F);
		...
		bodyModel[57].setRotationPoint(28.5F, -8F, -10F);
		...
		bodyModel[58].setRotationPoint(-27.5F, 1F, -12F);
		...
		bodyModel[59].setRotationPoint(-27.5F, -2F, -12F);
		...
		bodyModel[60].setRotationPoint(-27.5F, -5F, -12F);
		...
		bodyModel[61].setRotationPoint(-27.5F, -8F, -12F);
		...
		bodyModel[62].setRotationPoint(-27.5F, -8F, -12F);
		...
		bodyModel[63].setRotationPoint(-23.5F, -8F, -12F);
		...
		bodyModel[64].setRotationPoint(23.5F, 1F, -12F);
		...
		bodyModel[65].setRotationPoint(23.5F, -2F, -12F);
		...
		bodyModel[66].setRotationPoint(23.5F, -5F, -12F);
		...
		bodyModel[67].setRotationPoint(23.5F, -8F, -12F);
		...
		bodyModel[68].setRotationPoint(23.5F, -8F, -12F);
		...
		bodyModel[69].setRotationPoint(27.5F, -8F, -12F);
		...
		bodyModel[70].setRotationPoint(-27.5F, 1F, 12F);
		...
		bodyModel[71].setRotationPoint(-27.5F, -2F, 12F);
		...
		bodyModel[72].setRotationPoint(-27.5F, -5F, 12F);
		...
		bodyModel[73].setRotationPoint(-27.5F, -8F, 12F);
		...
		bodyModel[74].setRotationPoint(-27.5F, -8F, 11F);
		...
		bodyModel[75].setRotationPoint(-23.5F, -8F, 11F);
		...
		bodyModel[76].setRotationPoint(23.5F, 1F, 12F);
		...
		bodyModel[77].setRotationPoint(23.5F, -2F, 12F);
		...
		bodyModel[78].setRotationPoint(23.5F, -5F, 12F);
		...
		bodyModel[79].setRotationPoint(23.5F, -8F, 12F);
		...
		bodyModel[80].setRotationPoint(23.5F, -8F, 11F);
		...
		bodyModel[81].setRotationPoint(27.5F, -8F, 11F);
	}
}