...
public class Modelmechanicalreefer64 extends ModelConverter //Same as Filename
{
	int textureX = 256;
	int textureY = 256;

	public Modelmechanicalreefer64() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[35] = new ModelRendererTurbo(this, 231, 55, textureX, textureY); // Box 40 cull
		bodyModel[36] = new ModelRendererTurbo(this, 245, 55, textureX, textureY); // Box 40 cull
		...
		bodyModel[47] = new ModelRendererTurbo(this, 107, 138, textureX, textureY); // Box 118 cull
		bodyModel[48] = new ModelRendererTurbo(this, 203, 138, textureX, textureY); // Box 119
		bodyModel[49] = new ModelRendererTurbo(this, 94, 158, textureX, textureY); // Box 120 cull
		bodyModel[50] = new ModelRendererTurbo(this, 152, 158, textureX, textureY); // Box 121 cull
