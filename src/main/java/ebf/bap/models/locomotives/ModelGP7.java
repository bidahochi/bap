...
public class ModelGP7 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[21] = new ModelRendererTurbo(this, 329, 1, textureX, textureY); // Box 189 ditchlight front
		bodyModel[22] = new ModelRendererTurbo(this, 337, 1, textureX, textureY); // Box 190 ditchlight front
		...
		bodyModel[91] = new ModelRendererTurbo(this, 433, 1, textureX, textureY); // Box 247 headlight front 3
		...
		bodyModel[94] = new ModelRendererTurbo(this, 217, 9, textureX, textureY); // Box 359 headlight rear 1
		...
		bodyModel[102] = new ModelRendererTurbo(this, 497, 9, textureX, textureY); // Box 240 ditchlight rear
		bodyModel[103] = new ModelRendererTurbo(this, 1, 17, textureX, textureY); // Box 241 ditchlight rear
		...
		bodyModel[144] = new ModelRendererTurbo(this, 41, 33, textureX, textureY); // Box 149 headlight front 5
		bodyModel[145] = new ModelRendererTurbo(this, 297, 33, textureX, textureY); // Box 150
		bodyModel[146] = new ModelRendererTurbo(this, 65, 33, textureX, textureY); // Box 151 headlight front 4
		...
		bodyModel[194] = new ModelRendererTurbo(this, 505, 33, textureX, textureY); // Box 212 headlight rear big
		bodyModel[195] = new ModelRendererTurbo(this, 401, 97, textureX, textureY); // Box 213 erie large headlight
		bodyModel[196] = new ModelRendererTurbo(this, 41, 41, textureX, textureY); // Box 214 headlight front big
		bodyModel[197] = new ModelRendererTurbo(this, 505, 41, textureX, textureY); // Box 215 headlight front 1
		bodyModel[198] = new ModelRendererTurbo(this, 81, 49, textureX, textureY); // Box 216
		bodyModel[199] = new ModelRendererTurbo(this, 505, 49, textureX, textureY); // Box 217 headlight front 2
		bodyModel[200] = new ModelRendererTurbo(this, 505, 57, textureX, textureY); // Box 218 headlight front 1 gyra
		bodyModel[201] = new ModelRendererTurbo(this, 417, 97, textureX, textureY); // Box 219
		bodyModel[202] = new ModelRendererTurbo(this, 441, 65, textureX, textureY); // Box 220 headlight front 2 gyra
		bodyModel[203] = new ModelRendererTurbo(this, 65, 97, textureX, textureY); // Box 221 headlight rear 3
		bodyModel[204] = new ModelRendererTurbo(this, 433, 97, textureX, textureY); // Box 222
		bodyModel[205] = new ModelRendererTurbo(this, 137, 97, textureX, textureY); // Box 223 headlight rear 2
		bodyModel[206] = new ModelRendererTurbo(this, 297, 97, textureX, textureY); // Box 224 headlight rear 1 gyra
		bodyModel[207] = new ModelRendererTurbo(this, 441, 97, textureX, textureY); // Box 225
		bodyModel[208] = new ModelRendererTurbo(this, 321, 97, textureX, textureY); // Box 226 headlight rear 2 gyra
		...
		bodyModel[259] = new ModelRendererTurbo(this, 257, 113, textureX, textureY); // Box 186 lamp
		bodyModel[260] = new ModelRendererTurbo(this, 297, 113, textureX, textureY); // Box 187 lamp
		...
		bodyModel[267] = new ModelRendererTurbo(this, 177, 25, textureX, textureY); // Box 363 liveryimg 3 glow
		bodyModel[268] = new ModelRendererTurbo(this, 225, 25, textureX, textureY); // Box 364 liveryimg 3 glow
		...
		bodyModel[271] = new ModelRendererTurbo(this, 329, 97, textureX, textureY); // Box 288 commander beacon 1
		bodyModel[272] = new ModelRendererTurbo(this, 65, 105, textureX, textureY); // Box 162 commander beacon 2
		bodyModel[273] = new ModelRendererTurbo(this, 393, 113, textureX, textureY); // Box 165
		bodyModel[274] = new ModelRendererTurbo(this, 305, 105, textureX, textureY); // Box 162 commander beacon 3
		bodyModel[275] = new ModelRendererTurbo(this, 417, 113, textureX, textureY); // Box 165
		bodyModel[276] = new ModelRendererTurbo(this, 348, 125, textureX, textureY); // Box 3 cull
		bodyModel[277] = new ModelRendererTurbo(this, 372, 125, textureX, textureY); // Box 306 cull
		bodyModel[278] = new ModelRendererTurbo(this, 44, 23, textureX, textureY); // Box 117 liveryimg 2
		bodyModel[279] = new ModelRendererTurbo(this, 55, 23, textureX, textureY); // Box 118 liveryimg 2
		bodyModel[280] = new ModelRendererTurbo(this, 22, 23, textureX, textureY); // Box 115 liveryimg 2
		bodyModel[281] = new ModelRendererTurbo(this, 33, 23, textureX, textureY); // Box 116 liveryimg 2
		...
		bodyModel[286] = new ModelRendererTurbo(this, 184, 112, textureX, textureY); // Box 286 antenna plate cull
