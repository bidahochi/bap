...
public class ModelGM6C extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[52] = new ModelRendererTurbo(this, 1, 59, textureX, textureY); // Box 186 lamp
		bodyModel[53] = new ModelRendererTurbo(this, 1, 64, textureX, textureY); // Box 187 lamp
		...
		bodyModel[92] = new ModelRendererTurbo(this, 37, 86, textureX, textureY); // Box 294 lamp front nose
		bodyModel[93] = new ModelRendererTurbo(this, 29, 86, textureX, textureY); // Box 295 lamp front nose
		...
		bodyModel[111] = new ModelRendererTurbo(this, 410, 2, textureX, textureY); // Box 191
		bodyModel[112] = new ModelRendererTurbo(this, 415, 13, textureX, textureY); // Box 192
		...
		bodyModel[116] = new ModelRendererTurbo(this, 72, 16, textureX, textureY); // Box 198 numberboard
		bodyModel[117] = new ModelRendererTurbo(this, 64, 13, textureX, textureY); // Box 199 numberboard
		...
		bodyModel[130] = new ModelRendererTurbo(this, 12, 77, textureX, textureY); // Box 176 markerlight glow
		bodyModel[131] = new ModelRendererTurbo(this, 56, 77, textureX, textureY); // Box 176 markerlight glow
		...
		bodyModel[156] = new ModelRendererTurbo(this, 137, 17, textureX, textureY); // Box 6 PRIME1-1
		bodyModel[157] = new ModelRendererTurbo(this, 137, 17, textureX, textureY); // Box 7 PRIME1-3
		bodyModel[158] = new ModelRendererTurbo(this, 137, 17, textureX, textureY); // Box 8 PRIME1-2
		bodyModel[159] = new ModelRendererTurbo(this, 137, 17, textureX, textureY); // Box 9 PRIME1-4
		...
		bodyModel[166] = new ModelRendererTurbo(this, 80, 10, textureX, textureY); // Box 3 cull aww
		bodyModel[167] = new ModelRendererTurbo(this, 74, 3, textureX, textureY); // Box 5 aww
		bodyModel[168] = new ModelRendererTurbo(this, 392, 3, textureX, textureY); // Box 384 markerlight glow
		bodyModel[169] = new ModelRendererTurbo(this, 397, 3, textureX, textureY); // Box 385 markerlight glow
		bodyModel[170] = new ModelRendererTurbo(this, 456, 18, textureX, textureY); // Box 260 numberboard
		bodyModel[171] = new ModelRendererTurbo(this, 469, 18, textureX, textureY); // Box 261 numberboard
		...
		bodyModel[218] = new ModelRendererTurbo(this, 108, 84, textureX, textureY); // Box 412 ditchlight f
		bodyModel[219] = new ModelRendererTurbo(this, 72, 84, textureX, textureY); // Box 412 ditchlight f
		...
		bodyModel[52].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 186 lamp
		bodyModel[52].setRotationPoint(-42F, -18F, -1F);

		bodyModel[53].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 187 lamp
		...
		bodyModel[111].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 191
		bodyModel[111].setRotationPoint(46F, -21F, -1F);

		bodyModel[112].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 192
		...
		bodyModel[344].setRotationPoint(-37.6F, -8F, 0F);
		...
		bodyModel[345].setRotationPoint(-36F, -10F, 0F);
