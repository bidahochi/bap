...
public class ModelHH660 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[9].setRotationPoint(-29F, 9F, -11F);
		...
		bodyModel[26].setRotationPoint(-25F, -21F, -3F);
		...
		bodyModel[27].setRotationPoint(-25F, -21F, 3F);
		...
		bodyModel[28].setRotationPoint(-25F, -22F, -3F);

		bodyModel[29].addBox(0F, 0F, 0F, 36, 20, 14, 0F); // Box 41
		bodyModel[29].setRotationPoint(-23F, -20F, -7F);

		bodyModel[30].addBox(0F, 0F, 0F, 0, 2, 16, 0F); // Box 42
		bodyModel[30].setRotationPoint(29F, 0F, -8F);
		...
		bodyModel[33].setRotationPoint(-24F, -22F, -3F);
		...
		bodyModel[35].setRotationPoint(14F, -18F, -11F);

		bodyModel[36].addBox(0F, 0F, 0F, 11, 14, 1, 0F); // Box 49
		bodyModel[36].setRotationPoint(14F, -18F, 10F);
		...
		bodyModel[37].setRotationPoint(13F, -20F, 8F);
		...
		bodyModel[38].setRotationPoint(13F, -19F, 10F);
		...
		bodyModel[39].setRotationPoint(13F, -22F, 3F);

		bodyModel[40].addBox(0F, 0F, 0F, 7, 1, 4, 0F); // Box 135
		bodyModel[40].setRotationPoint(-10F, -22.5F, -2F);
		...
		bodyModel[41].setRotationPoint(13F, -22F, -8F);
		...
		bodyModel[42].setRotationPoint(13F, -20F, -10F);
		...
		bodyModel[52].setRotationPoint(24F, -20.5F, -8F);
		...
		bodyModel[53].setRotationPoint(24F, -19F, -10F);
		...
		bodyModel[54].setRotationPoint(24F, -19F, 8F);

		bodyModel[55].addBox(0F, 0F, 0F, 1, 3, 3, 0F); // Box 78 lamp rear
		bodyModel[55].setRotationPoint(24.5F, -21F, -1.5F);
		...
		bodyModel[56].setRotationPoint(24.5F, -18F, -1.5F);

		bodyModel[57].addBox(0F, 0F, 0F, 0, 1, 20, 0F); // Box 80
		bodyModel[57].setRotationPoint(-29F, 7F, -10F);
		...
		bodyModel[59].setRotationPoint(-26F, 8F, 7F);
		...
		bodyModel[61].setRotationPoint(26F, 8F, 7F);

		bodyModel[62].addBox(0F, 0F, 0F, 0, 1, 4, 0F); // Box 85
		bodyModel[62].setRotationPoint(26F, 8F, -11F);
		...
		bodyModel[64].setRotationPoint(29F, 8F, -11F);

		bodyModel[65].addBox(0F, 0F, 0F, 0, 1, 20, 0F); // Box 88
		bodyModel[65].setRotationPoint(29F, 7F, -10F);
		...
		bodyModel[67].setRotationPoint(-25.5F, -19F, -1.5F);

		bodyModel[68].addBox(0F, 0F, 0F, 2, 2, 23, 0F); // Box 92
		bodyModel[68].setRotationPoint(-17F, 1F, -11.5F);

		bodyModel[69].addBox(0F, 0F, 0F, 2, 2, 23, 0F); // Box 93
		bodyModel[69].setRotationPoint(12F, 1F, -11.5F);

		bodyModel[70].addBox(0F, 0F, 0F, 38, 8, 0, 0F); // Box 102
		bodyModel[70].setRotationPoint(-25F, -8F, -11F);
		...
		bodyModel[71].setRotationPoint(-27F, -8F, -11F);
		...
		bodyModel[72].setRotationPoint(10F, -9F, -11F);

		bodyModel[73].addBox(0F, 0F, 0F, 1, 7, 0, 0F); // Box 105
		bodyModel[73].setRotationPoint(11F, -16F, -11F);
		...
		bodyModel[74].setRotationPoint(11F, -18F, -11F);

		bodyModel[75].addBox(0F, 0F, 0F, 32, 8, 0, 0F); // Box 107
		bodyModel[75].setRotationPoint(-25F, -8F, 11F);

		bodyModel[76].addBox(0F, 0F, 0F, 1, 10, 0, 0F); // Box 108
		bodyModel[76].setRotationPoint(-27F, -6F, -11F);

		bodyModel[77].addBox(0F, 0F, 0F, 0, 1, 1, 0F); // Box 109
		bodyModel[77].setRotationPoint(-26F, 3F, -11F);

		bodyModel[78].addBox(0F, 0F, 0F, 0, 1, 1, 0F); // Box 110
		bodyModel[78].setRotationPoint(-26F, 3F, 10F);

		bodyModel[79].addBox(0F, 0F, 0F, 1, 10, 0, 0F); // Box 111
		bodyModel[79].setRotationPoint(-27F, -6F, 11F);
		...
		bodyModel[80].setRotationPoint(-27F, -8F, 11F);
		...
		bodyModel[81].setRotationPoint(-29F, 5F, -10F);

		bodyModel[82].addBox(0F, 0F, 0F, 0, 5, 1, 0F); // Box 114
		bodyModel[82].setRotationPoint(-29F, 0F, -10F);

		bodyModel[83].addBox(0F, 0F, 0F, 0, 8, 20, 0F); // Box 115
		bodyModel[83].setRotationPoint(-29F, -8F, -10F);
		...
		bodyModel[84].setRotationPoint(-29F, -8F, -10F);
		...
		bodyModel[85].setRotationPoint(-29F, -8F, 5F);

		bodyModel[86].addBox(0F, 0F, 0F, 0, 5, 1, 0F); // Box 118
		bodyModel[86].setRotationPoint(-29F, 0F, 9F);
		...
		bodyModel[87].setRotationPoint(-29F, 5F, 9F);
		...
		bodyModel[88].setRotationPoint(29F, 5F, -10F);

		bodyModel[89].addBox(0F, 0F, 0F, 0, 5, 1, 0F); // Box 127
		bodyModel[89].setRotationPoint(29F, 0F, -10F);
		...
		bodyModel[90].setRotationPoint(29F, 5F, 9F);

		bodyModel[91].addBox(0F, 0F, 0F, 0, 5, 1, 0F); // Box 129
		bodyModel[91].setRotationPoint(29F, 0F, 9F);
		...
		bodyModel[92].setRotationPoint(29F, -8F, 5F);

		bodyModel[93].addBox(0F, 0F, 0F, 0, 8, 20, 0F); // Box 131
		bodyModel[93].setRotationPoint(29F, -8F, -10F);
		...
		bodyModel[94].setRotationPoint(29F, -8F, -10F);

		bodyModel[95].addBox(0F, 0F, 0F, 3, 2, 0, 0F); // Box 137
		bodyModel[95].setRotationPoint(-29F, 7F, -10F);

		bodyModel[96].addBox(0F, 0F, 0F, 3, 3, 0, 0F); // Box 138
		bodyModel[96].setRotationPoint(-29F, 4.5F, -8F);
		...
		bodyModel[98].setRotationPoint(-21F, -19.5F, -7.5F);

		bodyModel[99].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 150 glow
		bodyModel[99].setRotationPoint(-21F, -19.5F, 6.5F);
		...
		bodyModel[100].setRotationPoint(24F, -20.5F, 3F);
		...
		bodyModel[101].setRotationPoint(24F, -20F, -8F);
		...
		bodyModel[102].setRotationPoint(24F, -20F, 3F);
		...
		bodyModel[103].setRotationPoint(13F, -20F, 3F);

		bodyModel[104].addBox(0F, 0F, 0F, 1, 1, 16, 0F); // Box 171
		bodyModel[104].setRotationPoint(13F, -19F, -8F);
		...
		bodyModel[105].setRotationPoint(13F, -19F, 8F);
		...
		bodyModel[106].setRotationPoint(13F, -20.5F, 3F);

		bodyModel[107].addBox(0F, 0F, 0F, 1, 2, 6, 0F); // Box 174
		bodyModel[107].setRotationPoint(13F, -21F, -3F);
		...
		bodyModel[108].setRotationPoint(13F, -20.5F, -8F);
		...
		bodyModel[109].setRotationPoint(13F, -20F, -8F);
		...
		bodyModel[110].setRotationPoint(13F, -19F, -10F);

		bodyModel[111].addBox(0F, 0F, 0F, 6, 9, 4, 0F); // Box 67
		bodyModel[111].setRotationPoint(12F, -12.98F, -3.5F);
		bodyModel[111].rotateAngleY = -0.6981317F;

		bodyModel[112].addBox(0F, 0F, 0F, 1, 4, 4, 0F); // Box 70
		bodyModel[112].setRotationPoint(14F, -13F, 2F);
		...
		bodyModel[113].setRotationPoint(14F, -21F, -1F);

		bodyModel[114].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 78 lantern
		bodyModel[114].setRotationPoint(19F, -21.5F, -1F);
		...
		bodyModel[115].setRotationPoint(-29.5F, -2F, 4.25F);
		...
		bodyModel[116].setRotationPoint(-29F, -2F, 4F);
		...
		bodyModel[117].setRotationPoint(-29F, -2F, -6F);
		...
		bodyModel[118].setRotationPoint(-29.5F, -2F, -5.75F);
		...
		bodyModel[119].setRotationPoint(30F, -2F, -4.25F);
		...
		bodyModel[120].setRotationPoint(29.5F, -2F, -4F);
		...
		bodyModel[121].setRotationPoint(29.5F, -2F, 6F);
		...
		bodyModel[122].setRotationPoint(30F, -2F, 5.75F);
		bodyModel[122].rotateAngleY = -3.14159265F;

		bodyModel[123].addBox(0F, 0F, 0F, 0, 6, 1, 0F); // Box 191
		bodyModel[123].setRotationPoint(26F, -3F, 10.5F);
		...
		bodyModel[124].setRotationPoint(26F, -8F, 6.5F);
		...
		bodyModel[125].setRotationPoint(26F, 3F, 10.5F);

		bodyModel[126].addBox(0F, 0F, 0F, 1, 1, 0, 0F); // Box 197
		bodyModel[126].setRotationPoint(25F, -8F, 6.5F);

		bodyModel[127].addBox(0F, 0F, 0F, 1, 1, 0, 0F); // Box 198
		bodyModel[127].setRotationPoint(25F, -8F, -6.5F);
		...
		bodyModel[128].setRotationPoint(26F, -8F, -11.5F);

		bodyModel[129].addBox(0F, 0F, 0F, 0, 6, 1, 0F); // Box 200
		bodyModel[129].setRotationPoint(26F, -3F, -11.5F);
		...
		bodyModel[130].setRotationPoint(26F, 3F, -11.5F);

		bodyModel[131].addBox(0F, 0F, 0F, 1, 9, 0, 0F); // Box 202
		bodyModel[131].setRotationPoint(25F, -17F, -2.5F);

		bodyModel[132].addBox(0F, 0F, 0F, 1, 9, 0, 0F); // Box 203
		bodyModel[132].setRotationPoint(25F, -17F, 2.5F);
		...
		bodyModel[133].setRotationPoint(11.5F, -21F, 8F);
		...
		bodyModel[134].setRotationPoint(12.5F, -21F, 8F);
		...
		bodyModel[135].setRotationPoint(13.5F, -21F, 8F);
		...
		bodyModel[136].setRotationPoint(14.5F, -23F, -0.5F);
		...
		bodyModel[137].setRotationPoint(15.5F, -23F, -0.5F);
		...
		bodyModel[138].setRotationPoint(16.5F, -23F, -0.5F);
		...
		bodyModel[139].setRotationPoint(18.32F, -23F, -0.5F);
		...
		bodyModel[140].setRotationPoint(18.5F, -23F, -0.5F);

		bodyModel[141].addBox(0F, 0F, 0F, 1, 2, 0, 0F); // Box 215
		bodyModel[141].setRotationPoint(20F, -22.5F, -6.5F);

		bodyModel[142].addBox(0F, 0F, 0F, 0, 5, 2, 0F); // Box 216
		bodyModel[142].setRotationPoint(14F, -16F, 10F);

		bodyModel[143].addBox(0F, 0F, 0F, 0, 5, 2, 0F); // Box 217
		bodyModel[143].setRotationPoint(14F, -16F, -12F);
		...
		bodyModel[144].setRotationPoint(16F, -18F, 11F);
		...
		bodyModel[145].setRotationPoint(16F, -18F, -12F);

		bodyModel[146].addBox(0F, 0F, 0F, 3, 1, 3, 0F); // Box 222
		bodyModel[146].setRotationPoint(-18F, -22.5F, -1.5F);

		bodyModel[147].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 227
		bodyModel[147].setRotationPoint(-29F, 9F, 10F);

		bodyModel[148].addBox(0F, 0F, 0F, 3, 2, 0, 0F); // Box 228
		bodyModel[148].setRotationPoint(-29F, 7F, 10F);

		bodyModel[149].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 229
		bodyModel[149].setRotationPoint(-29F, 7F, 8F);

		bodyModel[150].addBox(0F, 0F, 0F, 3, 3, 0, 0F); // Box 230
		bodyModel[150].setRotationPoint(-29F, 4.5F, 8F);

		bodyModel[151].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 231
		bodyModel[151].setRotationPoint(-29F, 4.5F, 7F);
		...
		bodyModel[155].setRotationPoint(-29.01F, -1.5F, -7F);

		bodyModel[156].addBox(0F, 0F, 0F, 0, 2, 14, 0F); // Box 251
		bodyModel[156].setRotationPoint(29.01F, -1.5F, -7F);

		bodyModel[157].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 221
		bodyModel[157].setRotationPoint(-17F, 3F, -1F);

		bodyModel[158].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 222
		bodyModel[158].setRotationPoint(12F, 3F, -1F);
		...
		bodyModel[159].setRotationPoint(-24F, -22F, -6F);
		...
		bodyModel[160].setRotationPoint(-23F, -21F, 6F);
		...
		bodyModel[161].setRotationPoint(-23F, -21F, -7F);

		bodyModel[162].addBox(0F, 0F, 0F, 37, 1, 12, 0F); // Box 227
		bodyModel[162].setRotationPoint(-24F, -21F, -6F);

		bodyModel[163].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 228
		bodyModel[163].setRotationPoint(-23F, -22.5F, -1F);
		...
		bodyModel[164].setRotationPoint(-25F, -22F, 3F);
		...
		bodyModel[165].setRotationPoint(-24F, -20F, 6F);
		...
		bodyModel[166].setRotationPoint(-24F, -21F, 6F);
		...
		bodyModel[167].setRotationPoint(-25F, -21F, -6F);
		...
		bodyModel[168].setRotationPoint(-25F, -22F, -6F);
		...
		bodyModel[169].setRotationPoint(-24F, -21F, -7F);
		...
		bodyModel[179].setRotationPoint(25F, -22F, -8F);
		...
		bodyModel[180].setRotationPoint(25F, -19F, -11F);
		...
		bodyModel[181].setRotationPoint(25F, -20F, -10F);
		...
		bodyModel[182].setRotationPoint(25F, -22F, 3F);
		...
		bodyModel[183].setRotationPoint(25F, -20F, 8F);
		...
		bodyModel[185].setRotationPoint(-18F, -24.5F, -1.5F);
		...
		bodyModel[188].setRotationPoint(-29F, -8F, -10F);
		...
		bodyModel[190].setRotationPoint(29F, -8F, 9F);
		...
		bodyModel[191].setRotationPoint(29F, -8F, -10F);
		...
		bodyModel[192].setRotationPoint(11F, -22F, 3F);
		...
		bodyModel[193].setRotationPoint(11F, -20F, 8F);
		...
		bodyModel[194].setRotationPoint(11F, -19F, 10F);
		...
		bodyModel[195].setRotationPoint(11F, -22F, -8F);
		...
		bodyModel[196].setRotationPoint(11F, -20F, -10F);
		...
		bodyModel[197].setRotationPoint(11F, -19F, -11F);
		...
		bodyModel[198].setRotationPoint(9.5F, -19.5F, 7F);
		...
		bodyModel[199].setRotationPoint(10.5F, -19.5F, 7F);
		...
		bodyModel[200].setRotationPoint(11.5F, -19.5F, 7F);
		...
		bodyModel[201].setRotationPoint(-27F, -20.5F, -0.5F);
		...
		bodyModel[202].setRotationPoint(-27F, -21.5F, -0.5F);
		...
		bodyModel[203].setRotationPoint(-26.75F, -20F, -0.25F);
		...
		bodyModel[204].setRotationPoint(-27F, -21.5F, -1F);
		...
		bodyModel[205].setRotationPoint(-27F, -21.5F, 1F);
		...
		bodyModel[206].setRotationPoint(-26.75F, -21.75F, -1.5F);
		...
		bodyModel[207].setRotationPoint(-14.5F, -19.5F, 7F);
		...
		bodyModel[208].setRotationPoint(-13.5F, -19.5F, 7F);
		...
		bodyModel[209].setRotationPoint(-15.5F, -19.5F, 7F);

		bodyModel[210].addBox(0F, 0F, 0F, 5, 0, 4, 0F); // Box 352
		bodyModel[210].setRotationPoint(-25F, -10F, -7.5F);

		bodyModel[211].addBox(0F, 0F, 0F, 5, 0, 4, 0F); // Box 353
		bodyModel[211].setRotationPoint(-25F, -10F, 3.5F);

		bodyModel[212].addBox(0F, 0F, 0F, 3, 2, 0, 0F); // Box 354
		bodyModel[212].setRotationPoint(26F, 7F, 10F);

		bodyModel[213].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 355
		bodyModel[213].setRotationPoint(26F, 9F, 10F);

		bodyModel[214].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 356
		bodyModel[214].setRotationPoint(26F, 7F, 8F);

		bodyModel[215].addBox(0F, 0F, 0F, 3, 3, 0, 0F); // Box 357
		bodyModel[215].setRotationPoint(26F, 4.5F, 8F);

		bodyModel[216].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 358
		bodyModel[216].setRotationPoint(26F, 4.5F, 7F);
		...
		bodyModel[219].setRotationPoint(26F, 9F, -11F);

		bodyModel[220].addBox(0F, 0F, 0F, 3, 2, 0, 0F); // Box 362
		bodyModel[220].setRotationPoint(26F, 7F, -10F);

		bodyModel[221].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 363
		bodyModel[221].setRotationPoint(26F, 7F, -10F);

		bodyModel[222].addBox(0F, 0F, 0F, 3, 3, 0, 0F); // Box 364
		bodyModel[222].setRotationPoint(26F, 4.5F, -8F);

		bodyModel[223].addBox(0F, 0F, 0F, 3, 0, 2, 0F); // Box 365
		bodyModel[223].setRotationPoint(26F, 4.5F, -9F);
		...
		bodyModel[225].setRotationPoint(7F, -5F, -11F);

		bodyModel[226].addBox(0F, 0F, 0F, 1, 4, 4, 0F); // Box 227
		bodyModel[226].setRotationPoint(12F, -4F, -11F);

		bodyModel[227].addBox(0F, 0F, 0F, 1, 2, 4, 0F); // Box 228
		bodyModel[227].setRotationPoint(11F, -2F, -11F);
	}
}