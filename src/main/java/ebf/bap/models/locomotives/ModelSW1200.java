...
public class ModelSW1200 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[36] = new ModelRendererTurbo(this, 319, 196, textureX, textureY); // Box 78 glow
		...
		bodyModel[76] = new ModelRendererTurbo(this, 168, 143, textureX, textureY); // Box 171 lamp headlight front double
		bodyModel[77] = new ModelRendererTurbo(this, 168, 143, textureX, textureY); // Box 172 lamp headlight front double
		...
		bodyModel[93] = new ModelRendererTurbo(this, 197, 143, textureX, textureY); // Box 197 lamp headlight rear double
		...
		bodyModel[96] = new ModelRendererTurbo(this, 197, 143, textureX, textureY); // Box 200 lamp headlight rear double
		...
		bodyModel[100] = new ModelRendererTurbo(this, 147, 152, textureX, textureY); // Box 167 liveryimg 2 glow
		bodyModel[101] = new ModelRendererTurbo(this, 147, 152, textureX, textureY); // Box 168 liveryimg 2 glow
		bodyModel[102] = new ModelRendererTurbo(this, 157, 141, textureX, textureY); // Box 169 lamp headlight front big
		bodyModel[103] = new ModelRendererTurbo(this, 186, 141, textureX, textureY); // Box 170 lamp headlight rear big
		bodyModel[104] = new ModelRendererTurbo(this, 137, 153, textureX, textureY); // Box 162 glow commander beacon
		bodyModel[105] = new ModelRendererTurbo(this, 136, 157, textureX, textureY); // Box 165
		bodyModel[106] = new ModelRendererTurbo(this, 205, 153, textureX, textureY); // Box 185 glow commander beacon
		bodyModel[107] = new ModelRendererTurbo(this, 204, 157, textureX, textureY); // Box 186
		bodyModel[108] = new ModelRendererTurbo(this, 184, 152, textureX, textureY); // Box 179 liveryimg 2 glow
		bodyModel[109] = new ModelRendererTurbo(this, 184, 152, textureX, textureY); // Box 180 liveryimg 2 glow
		...
		bodyModel[152] = new ModelRendererTurbo(this, 212, 156, textureX, textureY); // Box 6 PRIME1-1
		bodyModel[153] = new ModelRendererTurbo(this, 212, 156, textureX, textureY); // Box 7 PRIME1-3
		bodyModel[154] = new ModelRendererTurbo(this, 212, 156, textureX, textureY); // Box 8 PRIME1-2
		bodyModel[155] = new ModelRendererTurbo(this, 212, 156, textureX, textureY); // Box 9 PRIME1-4
		bodyModel[156] = new ModelRendererTurbo(this, 195, 161, textureX, textureY); // Box 478 cull
		bodyModel[157] = new ModelRendererTurbo(this, 212, 152, textureX, textureY); // Box 364 prime base
		bodyModel[158] = new ModelRendererTurbo(this, 212, 148, textureX, textureY); // Box 6 PRIME2-1
		bodyModel[159] = new ModelRendererTurbo(this, 212, 148, textureX, textureY); // Box 7 PRIME2-3
		bodyModel[160] = new ModelRendererTurbo(this, 212, 148, textureX, textureY); // Box 8 PRIME2-2
		bodyModel[161] = new ModelRendererTurbo(this, 212, 148, textureX, textureY); // Box 9 PRIME2-4
		...
		bodyModel[169] = new ModelRendererTurbo(this, 168, 148, textureX, textureY); // Box 189 lamp ditchlight front up
		bodyModel[170] = new ModelRendererTurbo(this, 168, 148, textureX, textureY); // Box 190 lamp ditchlight front up
		bodyModel[171] = new ModelRendererTurbo(this, 197, 148, textureX, textureY); // Box 182 lamp ditchlight rear up
		bodyModel[172] = new ModelRendererTurbo(this, 190, 148, textureX, textureY); // Box 183
		bodyModel[173] = new ModelRendererTurbo(this, 197, 148, textureX, textureY); // Box 186 lamp ditchlight rear up
		...
		bodyModel[181] = new ModelRendererTurbo(this, 348, 182, textureX, textureY); // Box 3 cull aww
		...
		bodyModel[186] = new ModelRendererTurbo(this, 480, 93, textureX, textureY); // Box 419 cull
		bodyModel[187] = new ModelRendererTurbo(this, 467, 93, textureX, textureY); // Box 420 cull
		...
		bodyModel[221] = new ModelRendererTurbo(this, 168, 115, textureX, textureY); // Box 551 tall front headlight
		bodyModel[222] = new ModelRendererTurbo(this, 168, 115, textureX, textureY); // Box 552 tall front headlight
		...
		bodyModel[258] = new ModelRendererTurbo(this, 377, 147, textureX, textureY); // Box 456 cull
		bodyModel[259] = new ModelRendererTurbo(this, 432, 147, textureX, textureY); // Box 457 cull
		...
		bodyModel[263] = new ModelRendererTurbo(this, 168, 153, textureX, textureY); // Box 601 lamp ditchlight front down
		bodyModel[264] = new ModelRendererTurbo(this, 168, 153, textureX, textureY); // Box 602 lamp ditchlight front down
		bodyModel[265] = new ModelRendererTurbo(this, 190, 153, textureX, textureY); // Box 603
		bodyModel[266] = new ModelRendererTurbo(this, 197, 153, textureX, textureY); // Box 604 lamp ditchlight rear down
		bodyModel[267] = new ModelRendererTurbo(this, 190, 153, textureX, textureY); // Box 605
		bodyModel[268] = new ModelRendererTurbo(this, 197, 153, textureX, textureY); // Box 606 lamp ditchlight rear down
		bodyModel[269] = new ModelRendererTurbo(this, 157, 123, textureX, textureY); // Box 607
		bodyModel[270] = new ModelRendererTurbo(this, 175, 134, textureX, textureY); // Box 385 headlight f SP
		bodyModel[271] = new ModelRendererTurbo(this, 175, 134, textureX, textureY); // Box 386 headlight f SP
		bodyModel[272] = new ModelRendererTurbo(this, 179, 123, textureX, textureY); // Box 610 gyralight double front sp
		bodyModel[273] = new ModelRendererTurbo(this, 179, 123, textureX, textureY); // Box 611 gyralight double front sp
		...
		bodyModel[276] = new ModelRendererTurbo(this, 177, 129, textureX, textureY); // Box 614 gyralight red front sp
		bodyModel[277] = new ModelRendererTurbo(this, 186, 123, textureX, textureY); // Box 615
		bodyModel[278] = new ModelRendererTurbo(this, 204, 134, textureX, textureY); // Box 616 headlight r sp
		bodyModel[279] = new ModelRendererTurbo(this, 204, 134, textureX, textureY); // Box 617 headlight r sp
		bodyModel[280] = new ModelRendererTurbo(this, 206, 129, textureX, textureY); // Box 618 gyralight red sp rear
		...
		bodyModel[283] = new ModelRendererTurbo(this, 208, 123, textureX, textureY); // Box 621 gyralight double sp rear
		bodyModel[284] = new ModelRendererTurbo(this, 208, 123, textureX, textureY); // Box 622 gyralight double sp rear
		...
		bodyModel[287] = new ModelRendererTurbo(this, 294, 147, textureX, textureY); // Box 625 sp numerbboard
		bodyModel[288] = new ModelRendererTurbo(this, 294, 134, textureX, textureY); // Box 626 sp numberboard
		...
		bodyModel[324] = new ModelRendererTurbo(this, 224, 155, textureX, textureY); // Box 162 commander beacon
		...
		bodyModel[327] = new ModelRendererTurbo(this, 233, 155, textureX, textureY); // Box 345 commander beacon
		bodyModel[328] = new ModelRendererTurbo(this, 222, 162, textureX, textureY); // Box 346 cull
		bodyModel[329] = new ModelRendererTurbo(this, 231, 162, textureX, textureY); // Box 347 cull
		...
		bodyModel[343] = new ModelRendererTurbo(this, 168, 136, textureX, textureY); // Box 363 ane front light gyra
		bodyModel[344] = new ModelRendererTurbo(this, 168, 136, textureX, textureY); // Box 364 ane front light gyra
		bodyModel[345] = new ModelRendererTurbo(this, 186, 134, textureX, textureY); // Box 365 ane shit
		bodyModel[346] = new ModelRendererTurbo(this, 197, 136, textureX, textureY); // Box 366 ane rear light gyra
		bodyModel[347] = new ModelRendererTurbo(this, 197, 136, textureX, textureY); // Box 367 ane rear light gyra
		...
		bodyModel[32].setRotationPoint(12F, -11F, 3.5F);
		...
		bodyModel[218].setRotationPoint(10.9F, -11F, 1F);
		...
		bodyModel[219].setRotationPoint(12.5F, -13F, 1F);
		...
		bodyModel[314].addShapeBox(0F, 0F, 0F, 14, 3, 3, 0F,0F, 0.5F, -1.5F, 0F, 0.5F, -1.5F, 0F, -1.5F, 0.5F, 0F, -1.5F, 0.5F, 0F, -1.5F, 0.5F, 0F, -1.5F, 0.5F, 0F, 0.5F, -1.5F, 0F, 0.5F, -1.5F); // Box 561 canfor bit
