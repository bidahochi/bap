...
public class ModelML4000 extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelML4000() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[66] = new ModelRendererTurbo(this, 1, 9, textureX, textureY); // Rear lamp U
		bodyModel[67] = new ModelRendererTurbo(this, 249, 9, textureX, textureY); // Rear lamp L
		bodyModel[68] = new ModelRendererTurbo(this, 17, 9, textureX, textureY); // Rear marker light R
		bodyModel[69] = new ModelRendererTurbo(this, 201, 9, textureX, textureY); // Rear marker light L
		bodyModel[70] = new ModelRendererTurbo(this, 241, 9, textureX, textureY); // Rear lamp U
		...
		bodyModel[99] = new ModelRendererTurbo(this, 489, 9, textureX, textureY); // Exhaust 1
		bodyModel[100] = new ModelRendererTurbo(this, 473, 17, textureX, textureY); // Exhaust 1
		bodyModel[101] = new ModelRendererTurbo(this, 97, 33, textureX, textureY); // Exhaust 1
		bodyModel[102] = new ModelRendererTurbo(this, 113, 33, textureX, textureY); // Exhaust 1
		...
		bodyModel[179] = new ModelRendererTurbo(this, 1, 33, textureX, textureY); // Front lamp U
		bodyModel[180] = new ModelRendererTurbo(this, 201, 33, textureX, textureY); // Front lamp L
		bodyModel[181] = new ModelRendererTurbo(this, 481, 41, textureX, textureY); // Front gyralight L
		bodyModel[182] = new ModelRendererTurbo(this, 321, 33, textureX, textureY); // Box 150
		bodyModel[183] = new ModelRendererTurbo(this, 497, 41, textureX, textureY); // Front gyralight L
		bodyModel[184] = new ModelRendererTurbo(this, 321, 89, textureX, textureY); // Box 150
		bodyModel[185] = new ModelRendererTurbo(this, 473, 49, textureX, textureY); // SP emergency light
		...
		bodyModel[193] = new ModelRendererTurbo(this, 369, 17, textureX, textureY); // Front marker light L
		bodyModel[194] = new ModelRendererTurbo(this, 377, 17, textureX, textureY); // Front marker light L
		...
		bodyModel[282] = new ModelRendererTurbo(this, 329, 113, textureX, textureY); // Rear lamp U
		...
		bodyModel[99].addShapeBox(0F, 0F, 0F, 2, 1, 2, 0F,0F, 0F, 0F, -0.75F, 0F, 0F, -0.75F, 0F, -0.75F, 0F, 0F, -0.75F, 0F, -0.5F, 0F, -0.75F, -0.5F, 0F, -0.75F, -0.5F, -0.75F, 0F, -0.5F, -0.75F); // Exhaust 1
		bodyModel[99].setRotationPoint(-19F, -20.87F, -0.62F);

		bodyModel[100].addShapeBox(0F, 0F, 0F, 2, 1, 2, 0F,0F, 0F, 0F, -0.75F, 0F, 0F, -0.75F, 0F, -0.75F, 0F, 0F, -0.75F, 0F, -0.5F, 0F, -0.75F, -0.5F, 0F, -0.75F, -0.5F, -0.75F, 0F, -0.5F, -0.75F); // Exhaust 1
		bodyModel[100].setRotationPoint(-11.25F, -20.87F, -0.62F);

		bodyModel[101].addShapeBox(0F, 0F, 0F, 2, 1, 2, 0F,0F, 0F, 0F, -0.75F, 0F, 0F, -0.75F, 0F, -0.75F, 0F, 0F, -0.75F, 0F, -0.5F, 0F, -0.75F, -0.5F, 0F, -0.75F, -0.5F, -0.75F, 0F, -0.5F, -0.75F); // Exhaust 1
		bodyModel[101].setRotationPoint(12F, -20.87F, -0.62F);

		bodyModel[102].addShapeBox(0F, 0F, 0F, 2, 1, 2, 0F,0F, 0F, 0F, -0.75F, 0F, 0F, -0.75F, 0F, -0.75F, 0F, 0F, -0.75F, 0F, -0.5F, 0F, -0.75F, -0.5F, 0F, -0.75F, -0.5F, -0.75F, 0F, -0.5F, -0.75F); // Exhaust 1
