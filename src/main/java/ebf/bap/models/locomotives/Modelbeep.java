...
public class Modelbeep extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[125] = new ModelRendererTurbo(this, 49, 89, textureX, textureY); // Back left lamp
		bodyModel[126] = new ModelRendererTurbo(this, 57, 89, textureX, textureY); // Back right lamp
		bodyModel[127] = new ModelRendererTurbo(this, 57, 81, textureX, textureY); // Box 890 cull
		...
		bodyModel[143] = new ModelRendererTurbo(this, 65, 89, textureX, textureY); // Box 215 lamp front
		bodyModel[144] = new ModelRendererTurbo(this, 249, 89, textureX, textureY); // Box 216 socket
		bodyModel[145] = new ModelRendererTurbo(this, 121, 89, textureX, textureY); // Box 217 lamp front
		bodyModel[146] = new ModelRendererTurbo(this, 113, 33, textureX, textureY); // Box 117 liveryimg 2
		bodyModel[147] = new ModelRendererTurbo(this, 193, 73, textureX, textureY); // Box 118 liveryimg 2
		...
		bodyModel[158] = new ModelRendererTurbo(this, 214, 156, textureX, textureY); // Box 399 glow green
		bodyModel[159] = new ModelRendererTurbo(this, 213, 159, textureX, textureY); // Box 400 socket
		bodyModel[160] = new ModelRendererTurbo(this, 207, 156, textureX, textureY); // Box 399 glow yellow
		bodyModel[161] = new ModelRendererTurbo(this, 206, 159, textureX, textureY); // Box 400 socket
		bodyModel[162] = new ModelRendererTurbo(this, 200, 156, textureX, textureY); // Box 399 glow red
		bodyModel[163] = new ModelRendererTurbo(this, 199, 159, textureX, textureY); // Box 400 socket
		bodyModel[164] = new ModelRendererTurbo(this, 193, 156, textureX, textureY); // Box 399 glow beacon
		bodyModel[165] = new ModelRendererTurbo(this, 192, 159, textureX, textureY); // Box 400 socket
		bodyModel[166] = new ModelRendererTurbo(this, 214, 147, textureX, textureY); // Box 399 glow green
		bodyModel[167] = new ModelRendererTurbo(this, 213, 150, textureX, textureY); // Box 400 socket
		bodyModel[168] = new ModelRendererTurbo(this, 207, 147, textureX, textureY); // Box 399 glow yellow
		bodyModel[169] = new ModelRendererTurbo(this, 206, 150, textureX, textureY); // Box 400 socket
		bodyModel[170] = new ModelRendererTurbo(this, 200, 147, textureX, textureY); // Box 399 glow red
		bodyModel[171] = new ModelRendererTurbo(this, 199, 150, textureX, textureY); // Box 400 socket
		bodyModel[172] = new ModelRendererTurbo(this, 193, 147, textureX, textureY); // Box 399 glow beacon
		...
		bodyModel[143].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 215 lamp front
		...
		bodyModel[145].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 217 lamp front
