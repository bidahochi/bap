...
public class Modeldash8_40b_b extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[142] = new ModelRendererTurbo(this, 119, 107, textureX, textureY); // Box 393 numberboard
		bodyModel[143] = new ModelRendererTurbo(this, 381, 127, textureX, textureY); // Box 394
		bodyModel[144] = new ModelRendererTurbo(this, 119, 107, textureX, textureY); // Box 395 numberboard
		bodyModel[145] = new ModelRendererTurbo(this, 107, 132, textureX, textureY); // Box 398 glow marker
		bodyModel[146] = new ModelRendererTurbo(this, 107, 132, textureX, textureY); // Box 399 glow marker
		...
		bodyModel[149] = new ModelRendererTurbo(this, 119, 122, textureX, textureY); // Box 190 ditchlight f u
		bodyModel[150] = new ModelRendererTurbo(this, 126, 123, textureX, textureY); // Box 275 ditchlight f l
		bodyModel[151] = new ModelRendererTurbo(this, 126, 128, textureX, textureY); // Box 444
		bodyModel[152] = new ModelRendererTurbo(this, 126, 123, textureX, textureY); // Box 445 ditchlight f l
		bodyModel[153] = new ModelRendererTurbo(this, 119, 122, textureX, textureY); // Box 446 ditchlight f u
		...
		bodyModel[168] = new ModelRendererTurbo(this, 140, 123, textureX, textureY); // Box 313 ditchlight r l
		bodyModel[169] = new ModelRendererTurbo(this, 133, 127, textureX, textureY); // Box 314
		bodyModel[170] = new ModelRendererTurbo(this, 133, 122, textureX, textureY); // Box 315 ditchlight r u
		bodyModel[171] = new ModelRendererTurbo(this, 140, 123, textureX, textureY); // Box 316 ditchlight r l
		...
		bodyModel[174] = new ModelRendererTurbo(this, 133, 122, textureX, textureY); // Box 319 ditchlight r u
		...
		bodyModel[196] = new ModelRendererTurbo(this, 126, 152, textureX, textureY); // Box 303 headlight front
		bodyModel[197] = new ModelRendererTurbo(this, 126, 152, textureX, textureY); // Box 304 headlight front
		bodyModel[198] = new ModelRendererTurbo(this, 119, 107, textureX, textureY); // Box 305 numberboard
		bodyModel[199] = new ModelRendererTurbo(this, 119, 107, textureX, textureY); // Box 306 numberboard
		bodyModel[200] = new ModelRendererTurbo(this, 107, 132, textureX, textureY); // Box 307 glow marker
		bodyModel[201] = new ModelRendererTurbo(this, 107, 132, textureX, textureY); // Box 308 glow marker
		...
		bodyModel[206] = new ModelRendererTurbo(this, 434, 71, textureX, textureY); // Box 162 commander beacon L
		bodyModel[207] = new ModelRendererTurbo(this, 433, 75, textureX, textureY); // Box 165
		bodyModel[208] = new ModelRendererTurbo(this, 427, 71, textureX, textureY); // Box 404 commander beacon R
		bodyModel[209] = new ModelRendererTurbo(this, 426, 75, textureX, textureY); // Box 405
		bodyModel[210] = new ModelRendererTurbo(this, 433, 66, textureX, textureY); // Box 389 support cull
