...
public class ModelGP7u extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[21] = new ModelRendererTurbo(this, 329, 1, textureX, textureY); // Box 189 ditchlight front up
		bodyModel[22] = new ModelRendererTurbo(this, 337, 1, textureX, textureY); // Box 190 ditchlight front up
		...
		bodyModel[75] = new ModelRendererTurbo(this, 497, 9, textureX, textureY); // Box 240 ditchlight rear up
		bodyModel[76] = new ModelRendererTurbo(this, 1, 17, textureX, textureY); // Box 241 ditchlight rear up
		...
		bodyModel[108] = new ModelRendererTurbo(this, 41, 33, textureX, textureY); // Box 149 headlight nose
		bodyModel[109] = new ModelRendererTurbo(this, 297, 33, textureX, textureY); // Box 150
		bodyModel[110] = new ModelRendererTurbo(this, 65, 33, textureX, textureY); // Box 151 headlight nose
		...
		bodyModel[136] = new ModelRendererTurbo(this, 65, 97, textureX, textureY); // Box 221 headlight rear
		bodyModel[137] = new ModelRendererTurbo(this, 433, 97, textureX, textureY); // Box 222
		bodyModel[138] = new ModelRendererTurbo(this, 137, 97, textureX, textureY); // Box 223 headlight rear
		...
		bodyModel[157] = new ModelRendererTurbo(this, 13, 71, textureX, textureY); // Box 117 liveryimg 2 glow
		bodyModel[158] = new ModelRendererTurbo(this, 2, 71, textureX, textureY); // Box 118 liveryimg 2 glow
		bodyModel[159] = new ModelRendererTurbo(this, 33, 80, textureX, textureY); // Box 186 headlight cab
		bodyModel[160] = new ModelRendererTurbo(this, 42, 66, textureX, textureY); // Box 187 headlight cab
		...
		bodyModel[166] = new ModelRendererTurbo(this, 90, 28, textureX, textureY); // Box 162 commander beacon 1
		...
		bodyModel[185] = new ModelRendererTurbo(this, 329, 12, textureX, textureY); // Box 300 ditchlight front down
		...
		bodyModel[188] = new ModelRendererTurbo(this, 301, 17, textureX, textureY); // Box 303 ditchlight front down
		...
		bodyModel[191] = new ModelRendererTurbo(this, 370, 94, textureX, textureY); // Box 3 cull
		...
		bodyModel[194] = new ModelRendererTurbo(this, 395, 93, textureX, textureY); // Box 311 cull
		...
		bodyModel[21].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 189 ditchlight front up
		bodyModel[21].setRotationPoint(-37.25F, -1F, 4.75F);

		bodyModel[22].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 190 ditchlight front up
		...
		bodyModel[23].setRotationPoint(-38F, 3.5F, -2F);

		bodyModel[24].addBox(0F, 0F, 0F, 0, 8, 20, 0F); // Box 3
		bodyModel[24].setRotationPoint(38.01F, 1F, -10F);

		bodyModel[25].addBox(0F, 0F, 0F, 4, 2, 14, 0F); // Box 266
		bodyModel[25].setRotationPoint(34F, 1F, -7F);

		bodyModel[26].addBox(0F, 0F, 0F, 4, 0, 1, 0F); // Box 271
		bodyModel[26].setRotationPoint(34F, 1F, -8F);

		bodyModel[27].addBox(0F, 0F, 0F, 4, 0, 3, 0F); // Box 272
		bodyModel[27].setRotationPoint(34F, 8F, -11F);

		bodyModel[28].addBox(0F, 0F, 0F, 4, 0, 3, 0F); // Box 273
		bodyModel[28].setRotationPoint(34F, 5F, -10F);
		...
		bodyModel[30].setRotationPoint(34F, 7F, -8F);
		...
		bodyModel[32].setRotationPoint(34F, 8F, 8F);

		bodyModel[33].addBox(0F, 0F, 0F, 4, 0, 3, 0F); // Box 273
		bodyModel[33].setRotationPoint(34F, 5F, 7F);
		...
		bodyModel[35].setRotationPoint(34F, 7F, 8F);

		bodyModel[36].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 276
		bodyModel[36].setRotationPoint(34F, 4F, 7F);

		bodyModel[37].addBox(0F, 0F, 0F, 4, 2, 3, 0F); // Box 5
		bodyModel[37].setRotationPoint(37F, 4F, -1.5F);
		...
		bodyModel[38].setRotationPoint(38.01F, -7F, -8F);
		bodyModel[38].rotateAngleY = -3.14159265F;

		bodyModel[39].addBox(0F, 0F, 0F, 0, 7, 1, 0F); // Box 61
		bodyModel[39].setRotationPoint(38.02F, -1F, 10F);
		...
		bodyModel[44].setRotationPoint(-33F, 3F, -11F);

		bodyModel[45].addBox(0F, 0F, 0F, 4, 0, 2, 0F); // Box 210
		bodyModel[45].setRotationPoint(-37F, 3F, -9F);
		...
		bodyModel[46].setRotationPoint(-33F, 3F, 6F);
		...
		bodyModel[48].setRotationPoint(33F, 3F, -3F);

		bodyModel[49].addBox(0F, 0F, 0F, 0, 8, 16, 0F); // Box 214
		bodyModel[49].setRotationPoint(-37F, -7F, -8F);

		bodyModel[50].addBox(0F, 0F, 0F, 9, 13, 14, 0F); // Box 215
		bodyModel[50].setRotationPoint(-31F, -12F, -7F);
		...
		bodyModel[51].setRotationPoint(-34F, -12F, -7F);
		...
		bodyModel[52].setRotationPoint(-34F, -12F, 1F);

		bodyModel[53].addBox(0F, 0F, 0F, 3, 13, 2, 0F); // Box 218
		bodyModel[53].setRotationPoint(-34F, -12F, -1F);
		...
		bodyModel[54].setRotationPoint(32F, -19F, -7F);

		bodyModel[55].addBox(0F, 0F, 0F, 3, 20, 2, 0F); // Box 220
		bodyModel[55].setRotationPoint(32F, -19F, -1F);
		...
		bodyModel[56].setRotationPoint(32F, -19F, 1F);

		bodyModel[57].addBox(0F, 0F, 0F, 42, 20, 14, 0F); // Box 223
		bodyModel[57].setRotationPoint(-10F, -19F, -7F);
		...
		bodyModel[72].setRotationPoint(34F, 3F, -11F);
		...
		bodyModel[73].setRotationPoint(34F, 3F, 6F);
		...
		bodyModel[74].setRotationPoint(37F, -1F, -6.75F);

		bodyModel[75].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 240 ditchlight rear up
		bodyModel[75].setRotationPoint(37.25F, -1F, -6.75F);

		bodyModel[76].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 241 ditchlight rear up
		bodyModel[76].setRotationPoint(37.25F, -1F, 4.75F);
		...
		bodyModel[77].setRotationPoint(37F, -1F, 4.75F);

		bodyModel[78].addBox(0F, 0F, 0F, 16, 2, 1, 0F); // Box 484
		bodyModel[78].setRotationPoint(-8F, 3F, 10F);
		...
		bodyModel[79].setRotationPoint(-11F, 6F, -10.5F);
		...
		bodyModel[80].setRotationPoint(-11F, 6F, 7.5F);

		bodyModel[81].addBox(0F, 0F, 0F, 15, 3, 15, 0F); // Box 488
		bodyModel[81].setRotationPoint(-11F, 6F, -7.5F);

		bodyModel[82].addBox(0F, 0F, 0F, 15, 2, 21, 0F); // Box 489
		bodyModel[82].setRotationPoint(-11F, 4F, -10.5F);
		...
		bodyModel[84].setRotationPoint(-14F, 3F, 11F);
		...
		bodyModel[85].setRotationPoint(12F, 3F, 11F);
		...
		bodyModel[87].setRotationPoint(-1F, -7F, 11.01F);

		bodyModel[88].addBox(0F, 0F, 0F, 35, 8, 0, 0F); // Box 176
		bodyModel[88].setRotationPoint(-1F, -7F, -11.01F);

		bodyModel[89].addBox(0F, 0F, 0F, 0, 8, 2, 0F); // Box 243
		bodyModel[89].setRotationPoint(34F, -7F, 9F);

		bodyModel[90].addBox(0F, 0F, 0F, 0, 8, 2, 0F); // Box 250
		bodyModel[90].setRotationPoint(34F, -7F, -11F);

		bodyModel[91].addBox(0F, 0F, 0F, 3, 3, 20, 0F); // Box 498
		bodyModel[91].setRotationPoint(5F, 5F, -10F);

		bodyModel[92].addBox(0F, 0F, 0F, 3, 3, 20, 0F); // Box 499
		bodyModel[92].setRotationPoint(9F, 5F, -10F);

		bodyModel[93].addBox(0F, 0F, 0F, 5, 8, 0, 0F); // Box 500
		bodyModel[93].setRotationPoint(-10F, -12F, -11.01F);
		...
		bodyModel[94].setRotationPoint(-5F, -12F, -11.01F);

		bodyModel[95].addBox(0F, 0F, 0F, 5, 8, 0, 0F); // Box 503
		bodyModel[95].setRotationPoint(-10F, -12F, 11.01F);
		...
		bodyModel[96].setRotationPoint(-31.01F, -12F, -11.01F);
		bodyModel[96].rotateAngleY = -3.14159265F;

		bodyModel[97].addBox(0F, 0F, 0F, 9, 8, 0, 0F); // Box 132
		bodyModel[97].setRotationPoint(-31F, -12F, -11.01F);

		bodyModel[98].addBox(0F, 0F, 0F, 1, 10, 0, 0F); // Box 133
		bodyModel[98].setRotationPoint(-34F, -6F, -11.01F);

		bodyModel[99].addBox(0F, 0F, 0F, 1, 10, 0, 0F); // Box 134
		bodyModel[99].setRotationPoint(-34F, -6F, 11.01F);
		...
		bodyModel[100].setRotationPoint(-31.01F, -12F, 11.02F);
		...
		bodyModel[102].setRotationPoint(-32F, -1F, -11F);

		bodyModel[103].addBox(0F, 0F, 0F, 2, 0, 6, 0F); // Box 138
		bodyModel[103].setRotationPoint(-32F, -1F, 5F);
		...
		bodyModel[104].setRotationPoint(-32F, -4F, -11.01F);

		bodyModel[105].addBox(0F, 0F, 0F, 1, 5, 0, 0F); // Box 140
		bodyModel[105].setRotationPoint(-31F, -4F, -11.01F);

		bodyModel[106].addBox(0F, 0F, 0F, 1, 5, 0, 0F); // Box 141
		bodyModel[106].setRotationPoint(-31F, -4F, 11.01F);
		...
		bodyModel[107].setRotationPoint(-32F, -4F, 11.01F);

		bodyModel[108].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 149 headlight nose
		bodyModel[108].setRotationPoint(-35.25F, -9.5F, -1F);

		bodyModel[109].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 150
		bodyModel[109].setRotationPoint(-34.5F, -11.5F, -1F);

		bodyModel[110].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 151 headlight nose
		bodyModel[110].setRotationPoint(-35.25F, -11.5F, -1F);

		bodyModel[111].addBox(0F, 0F, 0F, 1, 1, 14, 0F); // Box 152
		bodyModel[111].setRotationPoint(-32F, -11F, -7F);

		bodyModel[112].addBox(0F, 0F, 0F, 1, 3, 4, 0F); // Box 160
		bodyModel[112].setRotationPoint(-37.5F, -2F, -2F);
		...
		bodyModel[113].setRotationPoint(-37.5F, -3F, -2F);

		bodyModel[114].addBox(0F, 0F, 0F, 7, 1, 7, 0F); // Box 89
		bodyModel[114].setRotationPoint(7F, -20.5F, -3.5F);
		...
		bodyModel[116].setRotationPoint(6.5F, -18F, 7F);
		...
		bodyModel[117].setRotationPoint(1.5F, -18F, 7F);
		...
		bodyModel[118].setRotationPoint(14.5F, -18F, 7F);
		...
		bodyModel[119].setRotationPoint(6.5F, -20F, 7F);
		...
		bodyModel[120].setRotationPoint(1.5F, -20F, 7F);
		...
		bodyModel[121].setRotationPoint(14.5F, -20F, 7F);
		...
		bodyModel[122].setRotationPoint(6.5F, -20F, -9F);
		...
		bodyModel[123].setRotationPoint(14.5F, -20F, -9F);
		...
		bodyModel[124].setRotationPoint(14.5F, -18F, -9F);
		...
		bodyModel[125].setRotationPoint(6.5F, -18F, -9F);
		...
		bodyModel[126].setRotationPoint(1.5F, -18F, -9F);
		...
		bodyModel[127].setRotationPoint(1.5F, -20F, -9F);

		bodyModel[128].addBox(0F, 0F, 0F, 2, 2, 3, 0F); // Box 184
		bodyModel[128].setRotationPoint(3F, -21F, -1.5F);

		bodyModel[129].addBox(0F, 0F, 0F, 2, 2, 3, 0F); // Box 185
		bodyModel[129].setRotationPoint(16F, -21F, -1.5F);

		bodyModel[130].addBox(0F, 0F, 0F, 5, 1, 5, 0F); // Box 186
		bodyModel[130].setRotationPoint(-3.5F, -20F, -2.5F);

		bodyModel[131].addBox(0F, 0F, 0F, 5, 1, 5, 0F); // Box 187
		bodyModel[131].setRotationPoint(-9.5F, -20F, -2.5F);

		bodyModel[132].addBox(0F, 0F, 0F, 5, 1, 5, 0F); // Box 188
		bodyModel[132].setRotationPoint(25.5F, -20F, -2.5F);

		bodyModel[133].addBox(0F, 0F, 0F, 5, 1, 5, 0F); // Box 189
		bodyModel[133].setRotationPoint(19.5F, -20F, -2.5F);

		bodyModel[134].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 191
		bodyModel[134].setRotationPoint(31F, -19.5F, -1F);

		bodyModel[135].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 202
		bodyModel[135].setRotationPoint(-32F, -12.5F, -1F);

		bodyModel[136].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 221 headlight rear
		bodyModel[136].setRotationPoint(34.75F, -15F, -1F);

		bodyModel[137].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 222
		bodyModel[137].setRotationPoint(34.5F, -17F, -1F);

		bodyModel[138].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 223 headlight rear
		bodyModel[138].setRotationPoint(34.75F, -17F, -1F);

		bodyModel[139].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 230
		bodyModel[139].setRotationPoint(-11F, 3F, 10F);

		bodyModel[140].addBox(0F, 0F, 0F, 4, 2, 1, 0F); // Box 231
		bodyModel[140].setRotationPoint(8F, 3F, 10F);

		bodyModel[141].addBox(0F, 0F, 0F, 16, 2, 1, 0F); // Box 232
		bodyModel[141].setRotationPoint(-8F, 3F, -11F);

		bodyModel[142].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 233
		bodyModel[142].setRotationPoint(-11F, 3F, -11F);

		bodyModel[143].addBox(0F, 0F, 0F, 4, 2, 1, 0F); // Box 234
		bodyModel[143].setRotationPoint(8F, 3F, -11F);

		bodyModel[144].addBox(0F, 0F, 0F, 9, 1, 14, 0F); // Box 235
		bodyModel[144].setRotationPoint(4F, 4F, -7F);
		...
		bodyModel[145].setRotationPoint(-4F, -4F, -11.01F);
		...
		bodyModel[146].setRotationPoint(-4F, -4F, 11.01F);
		...
		bodyModel[153].setRotationPoint(-22F, -21F, 9F);
		...
		bodyModel[154].setRotationPoint(-25F, -21F, -1F);
		...
		bodyModel[155].setRotationPoint(-24F, -21F, -6F);
		...
		bodyModel[156].setRotationPoint(-24F, -21F, 1F);

		bodyModel[157].addBox(0F, 0F, 0F, 0, 2, 5, 0F); // Box 117 liveryimg 2 glow
		bodyModel[157].setRotationPoint(-22.05F, -20F, -6F);
		bodyModel[157].rotateAngleY = 0.38397244F;

		bodyModel[158].addBox(0F, 0F, -5F, 0, 2, 5, 0F); // Box 118 liveryimg 2 glow
		bodyModel[158].setRotationPoint(-22.05F, -20F, 6F);
		bodyModel[158].rotateAngleY = -0.38397244F;

		bodyModel[159].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 186 headlight cab
		bodyModel[159].setRotationPoint(-24.75F, -21F, -1F);

		bodyModel[160].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 187 headlight cab
		bodyModel[160].setRotationPoint(-24.75F, -19F, -1F);

		bodyModel[161].addBox(0F, 0F, 0F, 1, 3, 18, 0F); // Box 332
		bodyModel[161].setRotationPoint(-22F, -20F, -9F);

		bodyModel[162].addBox(0F, 0F, 0F, 1, 3, 18, 0F); // Box 333
		bodyModel[162].setRotationPoint(-11F, -20F, -9F);
		...
		bodyModel[163].setRotationPoint(-22F, -21F, -11F);

		bodyModel[164].addBox(0F, 0F, 0F, 2, 4, 2, 0F); // Box 297
		bodyModel[164].setRotationPoint(-24F, -21F, -1F);

		bodyModel[165].addBox(0F, 0F, 0F, 5, 0, 6, 0F); // Box 73
		bodyModel[165].setRotationPoint(-15F, -23F, -4F);

		bodyModel[166].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 162 commander beacon 1
		bodyModel[166].setRotationPoint(-19F, -22F, -8.5F);
		...
		bodyModel[167].setRotationPoint(-18.85F, -22F, -8.5F);

		bodyModel[168].addBox(0F, 0F, 0F, 0, 2, 1, 0F); // Box 179
		bodyModel[168].setRotationPoint(-15F, -23F, -3F);

		bodyModel[169].addBox(0F, 0F, 0F, 0, 2, 1, 0F); // Box 180
		bodyModel[169].setRotationPoint(-15F, -23F, 0F);

		bodyModel[170].addBox(0F, 0F, 0F, 1, 2, 0, 0F); // Box 181
		bodyModel[170].setRotationPoint(-12F, -23F, 2F);

		bodyModel[171].addBox(0F, 0F, 0F, 1, 2, 0, 0F); // Box 182
		bodyModel[171].setRotationPoint(-12F, -23F, -4F);

		bodyModel[172].addBox(0F, 0F, 0F, 5, 2, 8, 0F); // Box 184
		bodyModel[172].setRotationPoint(-20.5F, -22.75F, -4F);

		bodyModel[173].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 271
		bodyModel[173].setRotationPoint(-26F, -23F, 0.5F);

		bodyModel[174].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 272
		bodyModel[174].setRotationPoint(-24F, -23F, -0.5F);

		bodyModel[175].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 273
		bodyModel[175].setRotationPoint(-25F, -23F, -1.5F);

		bodyModel[176].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 274
		bodyModel[176].setRotationPoint(-23F, -22F, -0.5F);

		bodyModel[177].addBox(0F, 0F, 0F, 2, 2, 3, 0F); // Box 298
		bodyModel[177].setRotationPoint(7F, -21F, -1.5F);

		bodyModel[178].addBox(0F, 0F, 0F, 2, 2, 3, 0F); // Box 299
		bodyModel[178].setRotationPoint(12F, -21F, -1.5F);
		...
		bodyModel[183].setRotationPoint(-39F, 6F, -8F);
		...
		bodyModel[184].setRotationPoint(-39F, 6F, 0F);

		bodyModel[185].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 300 ditchlight front down
		bodyModel[185].setRotationPoint(-37.75F, 1.5F, -8.75F);
		...
		bodyModel[186].setRotationPoint(-37.5F, 1.5F, -8.75F);
		...
		bodyModel[187].setRotationPoint(-37.5F, 1.5F, 6.75F);

		bodyModel[188].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 303 ditchlight front down
		bodyModel[188].setRotationPoint(-37.75F, 1.5F, 6.75F);
		...
		bodyModel[189].setRotationPoint(-20F, -17F, 11F);
		...
		bodyModel[190].setRotationPoint(-20F, -17.25F, -11.97F);
		...
		bodyModel[191].setRotationPoint(-18.5F, -16F, 10F);
		...
		bodyModel[192].setRotationPoint(-18.5F, -17F, 10F);
		...
		bodyModel[193].setRotationPoint(-18.5F, -17F, -13F);
