...
public class Model25Ton extends ModelConverter //Same as Filename
{
	int textureX = 128;
	int textureY = 128;

	public Model25Ton() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[5] = new ModelRendererTurbo(this, 41, 52, textureX, textureY, StaticModelAnimator.tagWheel); // Box 30 wheel
		bodyModel[6] = new ModelRendererTurbo(this, 41, 52, textureX, textureY, StaticModelAnimator.tagWheel); // Box 46 wheel
		bodyModel[7] = new ModelRendererTurbo(this, 41, 52, textureX, textureY, StaticModelAnimator.tagWheel); // Box 47 wheel
		bodyModel[8] = new ModelRendererTurbo(this, 41, 52, textureX, textureY, StaticModelAnimator.tagWheel); // Box 48 wheel
		...
		bodyModel[89] = new ModelRendererTurbo(this, 4, 123, textureX, textureY); // Box 251 headlight front
		bodyModel[90] = new ModelRendererTurbo(this, 4, 121, textureX, textureY); // Box 252 headlight front
		bodyModel[91] = new ModelRendererTurbo(this, 4, 123, textureX, textureY); // Box 253 headlight front
		bodyModel[92] = new ModelRendererTurbo(this, 4, 121, textureX, textureY); // Box 254 headlight front
		bodyModel[93] = new ModelRendererTurbo(this, 1, 123, textureX, textureY); // Box 255 headlight rear
		bodyModel[94] = new ModelRendererTurbo(this, 1, 123, textureX, textureY); // Box 256 headlight rear
		bodyModel[95] = new ModelRendererTurbo(this, 1, 121, textureX, textureY); // Box 257 headlight rear
		bodyModel[96] = new ModelRendererTurbo(this, 1, 121, textureX, textureY); // Box 258 headlight rear
		...
		bodyModel[120] = new ModelRendererTurbo(this, 48, 48, textureX, textureY); // Box 6 PRIME1-1
		bodyModel[121] = new ModelRendererTurbo(this, 48, 48, textureX, textureY); // Box 7 PRIME1-3
		bodyModel[122] = new ModelRendererTurbo(this, 48, 48, textureX, textureY); // Box 8 PRIME1-2
		bodyModel[123] = new ModelRendererTurbo(this, 48, 48, textureX, textureY); // Box 9 PRIME1-4
