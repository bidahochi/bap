...
public class ModelEP1A extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[50] = new ModelRendererTurbo(this, 40, 13, textureX, textureY); // Headlight top left
		...
		bodyModel[53] = new ModelRendererTurbo(this, 34, 13, textureX, textureY); // Headlight top right
		bodyModel[54] = new ModelRendererTurbo(this, 40, 17, textureX, textureY); // Headlight bottom left
		bodyModel[55] = new ModelRendererTurbo(this, 34, 17, textureX, textureY); // Headlight bottom right
		...
		bodyModel[113] = new ModelRendererTurbo(this, 178, 198, textureX, textureY); // Face headlight top left
		bodyModel[114] = new ModelRendererTurbo(this, 170, 198, textureX, textureY); // Face headlight top right
		bodyModel[115] = new ModelRendererTurbo(this, 178, 201, textureX, textureY); // Face headlight bottom left
		bodyModel[116] = new ModelRendererTurbo(this, 170, 201, textureX, textureY); // Face headlight bottom right
		...
		bodyModel[229] = new ModelRendererTurbo(this, 1, 100, textureX, textureY); // Engineer's body door
		bodyModel[230] = new ModelRendererTurbo(this, 1, 116, textureX, textureY); // Fireman's body door
		...
		bodyModel[229].addBox(0F, 0F, 0F, 4, 14, 1, 0F); // Engineer's body door
		bodyModel[229].setRotationPoint(-29F, -17F, 10F);

		bodyModel[230].addBox(0F, 0F, 0F, 4, 14, 1, 0F); // Fireman's body door
