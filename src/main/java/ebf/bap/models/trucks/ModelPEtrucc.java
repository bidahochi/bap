...
public class ModelPEtrucc extends ModelConverter //Same as Filename
{
    ...
    {
        bodyModel[0] = new ModelRendererTurbo(this, 2, 27, textureX, textureY, StaticModelAnimator.tagWheel); // Box 90 w
        ...
        bodyModel[3] = new ModelRendererTurbo(this, 2, 27, textureX, textureY,StaticModelAnimator.tagWheel); // Box 10w
        bodyModel[4] = new ModelRendererTurbo(this, 2, 27, textureX, textureY,StaticModelAnimator.tagWheel); // Box 11w
        bodyModel[5] = new ModelRendererTurbo(this, 2, 27, textureX, textureY,StaticModelAnimator.tagWheel); // Box 13w
