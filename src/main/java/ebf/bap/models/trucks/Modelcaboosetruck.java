...
public class Modelcaboosetruck extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[5] = new ModelRendererTurbo(this, 73, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 16-
		...
		bodyModel[26] = new ModelRendererTurbo(this, 313, 1, textureX, textureY,StaticModelAnimator.tagWheel); // Box 44-
		bodyModel[27] = new ModelRendererTurbo(this, 329, 1, textureX, textureY,StaticModelAnimator.tagWheel); // Box 45-
		bodyModel[28] = new ModelRendererTurbo(this, 345, 1, textureX, textureY,StaticModelAnimator.tagWheel); // Box 46-
