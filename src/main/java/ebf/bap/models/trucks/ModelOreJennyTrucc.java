...
public class ModelOreJennyTrucc extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[27] = new ModelRendererTurbo(this, 305, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 44 wheel
		bodyModel[28] = new ModelRendererTurbo(this, 321, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 45 wheel
		bodyModel[29] = new ModelRendererTurbo(this, 337, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 46 wheel
		...
		bodyModel[1].setRotationPoint(-1.5F, 6F, -8.5F);
		...
		bodyModel[2].setRotationPoint(-6.5F, 5F, -8F);

		bodyModel[3].addBox(0F, 0F, 0F, 11, 1, 1, 0F); // Box 4
		bodyModel[3].setRotationPoint(-5.5F, 5F, -8F);

		bodyModel[4].addBox(0F, 0F, 0F, 2, 2, 16, 0F); // Box 14
		bodyModel[4].setRotationPoint(-5.5F, 6F, -8F);

		bodyModel[5].addBox(-3F, -3F, 0F, 6, 6, 0, 0F); // Box 16 wheel
		bodyModel[5].setRotationPoint(-4.5F, 7F, -6F);

		bodyModel[6].addBox(0F, 0F, 0F, 2, 2, 16, 0F); // Box 22
		bodyModel[6].setRotationPoint(3.5F, 6F, -8F);
		...
		bodyModel[8].setRotationPoint(-3.5F, 6F, -8F);
		...
		bodyModel[9].setRotationPoint(-1.5F, 8F, -8F);
		...
		bodyModel[10].setRotationPoint(1.5F, 6F, -8F);
		...
		bodyModel[11].setRotationPoint(-1.5F, 7F, -8.5F);
		...
		bodyModel[12].setRotationPoint(-3.5F, 7F, -7.5F);
		...
		bodyModel[13].setRotationPoint(2.5F, 7F, -7.5F);
		...
		bodyModel[14].setRotationPoint(3.5F, 6F, -8.5F);
		...
		bodyModel[15].setRotationPoint(5.5F, 5F, -8F);

		bodyModel[16].addBox(0F, 0F, 0F, 11, 1, 1, 0F); // Box 33
		bodyModel[16].setRotationPoint(-5.5F, 5F, 7F);
		...
		bodyModel[17].setRotationPoint(-6.5F, 5F, 7F);
		...
		bodyModel[18].setRotationPoint(-3.5F, 6F, 7F);
		...
		bodyModel[19].setRotationPoint(-5.5F, 6F, 7.5F);
		...
		bodyModel[20].setRotationPoint(-1.5F, 8F, 7F);
		...
		bodyModel[21].setRotationPoint(1.5F, 6F, 7F);
		...
		bodyModel[22].setRotationPoint(3.5F, 6F, 7.5F);
		...
		bodyModel[23].setRotationPoint(5.5F, 5F, 7F);
		...
		bodyModel[24].setRotationPoint(2.5F, 7F, 7.5F);
		...
		bodyModel[25].setRotationPoint(-3.5F, 7F, 7.5F);
		...
		bodyModel[26].setRotationPoint(-1.5F, 7F, 6.5F);

		bodyModel[27].addBox(-3F, -3F, 0F, 6, 6, 0, 0F); // Box 44 wheel
		bodyModel[27].setRotationPoint(4.5F, 7F, -6F);

		bodyModel[28].addBox(-3F, -3F, 0F, 6, 6, 0, 0F); // Box 45 wheel
		bodyModel[28].setRotationPoint(4.5F, 7F, 6F);

		bodyModel[29].addBox(-3F, -3F, 0F, 6, 6, 0, 0F); // Box 46 wheel
		bodyModel[29].setRotationPoint(-4.5F, 7F, 6F);
	}
}