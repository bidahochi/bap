...
public class ModelFB2 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[6].setRotationPoint(-9.5F, 5F, -5.5F);
		...
		bodyModel[7].setRotationPoint(-8F, 3.75F, -9.5F);

		bodyModel[8].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 52
		bodyModel[8].setRotationPoint(-6F, 4.65F, -9.5F);

		bodyModel[9].addBox(0F, 0F, 0F, 7, 0, 1, 0F); // Box 63
		bodyModel[9].setRotationPoint(3.5F, 8.51F, -8.25F);

		bodyModel[10].addBox(0F, 0F, 0F, 0, 3, 1, 0F); // Box 64
		bodyModel[10].setRotationPoint(10.5F, 5.51F, -8.25F);

		bodyModel[11].addBox(0F, 0F, 0F, 7, 0, 1, 0F); // Box 69
		bodyModel[11].setRotationPoint(-10.5F, 8.51F, -8.25F);

		bodyModel[12].addBox(0F, 0F, 0F, 0, 3, 1, 0F); // Box 70
		bodyModel[12].setRotationPoint(-10.5F, 5.51F, -8.25F);
		...
		bodyModel[13].setRotationPoint(-8F, 6F, -9.5F);
		...
		bodyModel[14].setRotationPoint(6F, 6F, -9.5F);
		...
		bodyModel[15].setRotationPoint(6F, 6F, 8.5F);
		...
		bodyModel[16].setRotationPoint(-8F, 6F, 8.5F);

		bodyModel[17].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 101
		bodyModel[17].setRotationPoint(-8.5F, 3.5F, -8.5F);
		...
		bodyModel[18].setRotationPoint(-2.5F, 6.5F, -8.5F);
		...
		bodyModel[19].setRotationPoint(2.5F, 3.5F, -8.5F);

		bodyModel[20].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 105
		bodyModel[20].setRotationPoint(5.5F, 3.5F, -8.5F);
		...
		bodyModel[21].setRotationPoint(-10.5F, 3.5F, -8.25F);
		...
		bodyModel[22].setRotationPoint(9.5F, 3.5F, -8.25F);
		...
		bodyModel[23].setRotationPoint(-10F, 5.5F, -8.25F);
		...
		bodyModel[24].setRotationPoint(-6F, 5.5F, -8.25F);
		...
		bodyModel[25].setRotationPoint(8F, 5.5F, -8.25F);
		...
		bodyModel[26].setRotationPoint(4F, 5.5F, -8.25F);
		...
		bodyModel[27].setRotationPoint(-5.5F, 3.5F, -8.5F);

		bodyModel[28].addBox(0F, 0F, 0F, 5, 1, 3, 0F); // Box 114
		bodyModel[28].setRotationPoint(-2.5F, 3.5F, -8.5F);
		...
		bodyModel[29].setRotationPoint(-2.25F, 4.25F, -8.5F);
		...
		bodyModel[30].setRotationPoint(0.25F, 4.25F, -8.5F);

		bodyModel[31].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 117
		bodyModel[31].setRotationPoint(8.5F, 3.5F, -8.25F);

		bodyModel[32].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 118
		bodyModel[32].setRotationPoint(-9.5F, 3.5F, -8.25F);
		...
		bodyModel[33].setRotationPoint(-4F, 4.65F, -9.5F);

		bodyModel[34].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 120
		bodyModel[34].setRotationPoint(5.5F, 3.5F, 7.5F);
		...
		bodyModel[35].setRotationPoint(2.5F, 3.5F, 7.5F);
		...
		bodyModel[36].setRotationPoint(-2.5F, 6.5F, 7.5F);
		...
		bodyModel[37].setRotationPoint(-5.5F, 3.5F, 7.5F);
		...
		bodyModel[39].setRotationPoint(8.5F, 3.5F, 7.25F);
		...
		bodyModel[40].setRotationPoint(9.5F, 3.5F, 7.25F);
		...
		bodyModel[41].setRotationPoint(8F, 5.5F, 7.25F);
		...
		bodyModel[42].setRotationPoint(4F, 5.5F, 7.25F);
		...
		bodyModel[43].setRotationPoint(-6F, 5.5F, 7.25F);
		...
		bodyModel[44].setRotationPoint(-10F, 5.5F, 7.25F);

		bodyModel[45].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 131
		bodyModel[45].setRotationPoint(-9.5F, 3.5F, 7.25F);
		...
		bodyModel[46].setRotationPoint(-10.5F, 3.5F, 7.25F);
		...
		bodyModel[47].setRotationPoint(0.25F, 4.25F, 6.5F);
		...
		bodyModel[48].setRotationPoint(-2.25F, 4.25F, 6.5F);

		bodyModel[49].addBox(0F, 0F, 0F, 6, 4, 11, 0F); // Box 136
		bodyModel[49].setRotationPoint(3.5F, 5F, -5.5F);

		bodyModel[50].addBox(0F, 0F, 0F, 7, 4, 12, 0F); // Box 137
		bodyModel[50].setRotationPoint(-3.5F, 4.5F, -6F);
		...
		bodyModel[51].setRotationPoint(6.5F, 3.5F, -9.25F);
		...
		bodyModel[53].setRotationPoint(-6F, 4.65F, 8.5F);
		...
		bodyModel[54].setRotationPoint(-4F, 4.65F, 5.5F);
		...
		bodyModel[55].setRotationPoint(-8F, 3.75F, 8.5F);
		...
		bodyModel[56].setRotationPoint(6.5F, 3.5F, 9.25F);
		...
		bodyModel[57].setRotationPoint(6F, 3F, 8F);

		bodyModel[58].addBox(0F, 0F, 0F, 7, 0, 1, 0F); // Box 58
		bodyModel[58].setRotationPoint(3.5F, 8.51F, 7.25F);

		bodyModel[59].addBox(0F, 0F, 0F, 0, 3, 1, 0F); // Box 59
		bodyModel[59].setRotationPoint(10.5F, 5.51F, 7.25F);

		bodyModel[60].addBox(0F, 0F, 0F, 7, 0, 1, 0F); // Box 60
		bodyModel[60].setRotationPoint(-10.5F, 8.51F, 7.25F);

		bodyModel[61].addBox(0F, 0F, 0F, 0, 3, 1, 0F); // Box 61
		bodyModel[61].setRotationPoint(-10.5F, 5.51F, 7.25F);
		...
		bodyModel[63].setRotationPoint(-1F, 3.5F, -1F);
	}
}