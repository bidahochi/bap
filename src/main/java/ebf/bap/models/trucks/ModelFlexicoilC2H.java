...
public class ModelFlexicoilC2H extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelFlexicoilC2H() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[7] = new ModelRendererTurbo(this, 89, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 10 wheel
		bodyModel[8] = new ModelRendererTurbo(this, 105, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 11 wheel
		...
		bodyModel[0].setRotationPoint(-11F, 6.5F, -6F);
		...
		bodyModel[2].setRotationPoint(-12F, 5.5F, -9F);

		bodyModel[3].addBox(-3F, -3F, 0F, 6, 6, 0, 0F); // Box 3 wheel
		bodyModel[3].setRotationPoint(-11F, 6.5F, 6F);
		...
		bodyModel[6].setRotationPoint(10F, 5.5F, -9F);
		...
		bodyModel[8].setRotationPoint(11F, 6.5F, 6F);
		...
		bodyModel[9].setRotationPoint(-14F, 5F, -9F);
		...
		bodyModel[10].setRotationPoint(-10F, 5F, -9F);
		...
		bodyModel[11].setRotationPoint(1F, 5F, -9F);
		...
		bodyModel[12].setRotationPoint(-3F, 5F, -9F);
		...
		bodyModel[13].setRotationPoint(8F, 5F, -9F);
		...
		bodyModel[14].setRotationPoint(12F, 5F, -9F);
		...
		bodyModel[15].setRotationPoint(-12F, 5.5F, -9.5F);
		...
		bodyModel[16].setRotationPoint(-1F, 5.5F, -9.5F);
		...
		bodyModel[17].setRotationPoint(10F, 5.5F, -9.5F);

		bodyModel[18].addBox(0F, 0F, 0F, 10, 4, 10, 0F); // Box 51
		bodyModel[18].setRotationPoint(-13F, 4F, -5F);

		bodyModel[19].addBox(0F, 0F, 0F, 10, 4, 10, 0F); // Box 52
		bodyModel[19].setRotationPoint(3F, 4F, -5F);

		bodyModel[20].addBox(0F, 0F, 0F, 6, 5, 10, 0F); // Box 53
		bodyModel[20].setRotationPoint(-3F, 3F, -5F);
		...
		bodyModel[21].setRotationPoint(1F, 5F, 8F);
		...
		bodyModel[22].setRotationPoint(-3F, 5F, 8F);
		...
		bodyModel[23].setRotationPoint(-10F, 5F, 8F);
		...
		bodyModel[24].setRotationPoint(-14F, 5F, 8F);
		...
		bodyModel[25].setRotationPoint(8F, 5F, 8F);
		...
		bodyModel[27].setRotationPoint(-1F, 5.5F, 8.5F);
		...
		bodyModel[28].setRotationPoint(-12F, 5.5F, 8.5F);
		...
		bodyModel[29].setRotationPoint(10F, 5.5F, 8.5F);

		bodyModel[30].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 85
		bodyModel[30].setRotationPoint(10F, 3.05F, 9F);

		bodyModel[31].addBox(0F, 0F, 0F, 1, 0, 1, 0F); // Box 86
		bodyModel[31].setRotationPoint(9F, 3.5F, 9F);
		...
		bodyModel[32].setRotationPoint(8F, 3.5F, 8F);
		...
		bodyModel[33].setRotationPoint(-9F, 3.5F, 8F);

		bodyModel[34].addBox(0F, 0F, 0F, 1, 0, 1, 0F); // Box 92
		bodyModel[34].setRotationPoint(-10F, 3.45F, 9F);

		bodyModel[35].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 93
		bodyModel[35].setRotationPoint(-12F, 3.05F, 9F);

		bodyModel[36].addBox(0F, 0F, 0F, 4, 0, 1, 0F); // Box 94
		bodyModel[36].setRotationPoint(-13F, 8F, 7.5F);
		...
		bodyModel[37].setRotationPoint(-3F, 3.5F, 8F);

		bodyModel[38].addBox(0F, 0F, 0F, 5, 2, 1, 0F); // Box 101
		bodyModel[38].setRotationPoint(-8F, 4F, 8F);
		...
		bodyModel[39].setRotationPoint(-14F, 4F, 7.5F);
		...
		bodyModel[40].setRotationPoint(-3F, 4F, 7.5F);
		...
		bodyModel[42].setRotationPoint(-2F, 8F, 7.5F);

		bodyModel[43].addBox(0F, 0F, 0F, 4, 0, 1, 0F); // Box 108
		bodyModel[43].setRotationPoint(9F, 8F, 7.5F);
		...
		bodyModel[44].setRotationPoint(-11F, 3.5F, 8F);
		...
		bodyModel[45].setRotationPoint(8F, 3.5F, 8F);
		...
		bodyModel[46].setRotationPoint(-14F, 3.5F, 8F);

		bodyModel[47].addBox(0F, 0F, 0F, 7, 1, 0, 0F); // Box 115
		bodyModel[47].setRotationPoint(-9F, 6.5F, 8F);
		...
		bodyModel[48].setRotationPoint(0F, 3.5F, 8F);

		bodyModel[49].addBox(0F, 0F, 0F, 5, 2, 1, 0F); // Box 117
		bodyModel[49].setRotationPoint(3F, 4F, 8F);

		bodyModel[50].addBox(0F, 0F, 0F, 7, 1, 0, 0F); // Box 118
		bodyModel[50].setRotationPoint(2F, 6.5F, 8F);
		...
		bodyModel[51].setRotationPoint(-12F, 2.5F, 8F);
		...
		bodyModel[52].setRotationPoint(-0.5F, 2.5F, 8F);
		...
		bodyModel[53].setRotationPoint(-0.5F, 3.5F, 9F);
		...
		bodyModel[54].setRotationPoint(11F, 3.5F, 8F);

		bodyModel[55].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 123
		bodyModel[55].setRotationPoint(14F, 4F, 8F);

		bodyModel[56].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 124
		bodyModel[56].setRotationPoint(14F, 4F, -9F);

		bodyModel[57].addBox(0F, 0F, 0F, 5, 2, 1, 0F); // Box 125
		bodyModel[57].setRotationPoint(3F, 4F, -9F);
		...
		bodyModel[58].setRotationPoint(11F, 3.5F, -9F);
		...
		bodyModel[59].setRotationPoint(8F, 3.5F, -9F);
		...
		bodyModel[60].setRotationPoint(0F, 3.5F, -9F);
		...
		bodyModel[61].setRotationPoint(-0.5F, 2.5F, -9F);
		...
		bodyModel[62].setRotationPoint(-3F, 3.5F, -9F);

		bodyModel[63].addBox(0F, 0F, 0F, 5, 2, 1, 0F); // Box 131
		bodyModel[63].setRotationPoint(-8F, 4F, -9F);
		...
		bodyModel[64].setRotationPoint(-11F, 3.5F, -9F);
		...
		bodyModel[65].setRotationPoint(-14F, 3.5F, -9F);
		...
		bodyModel[66].setRotationPoint(-12F, 2.5F, -9F);

		bodyModel[67].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 136
		bodyModel[67].setRotationPoint(-12F, 3.05F, -10F);

		bodyModel[68].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 137
		bodyModel[68].setRotationPoint(10F, 3.05F, -10F);

		bodyModel[69].addBox(0F, 0F, 0F, 1, 0, 1, 0F); // Box 138
		bodyModel[69].setRotationPoint(9F, 3.5F, -10F);
		...
		bodyModel[70].setRotationPoint(8F, 3.5F, -10F);

		bodyModel[71].addBox(0F, 0F, 0F, 1, 0, 1, 0F); // Box 140
		bodyModel[71].setRotationPoint(-10F, 3.5F, -10F);
		...
		bodyModel[72].setRotationPoint(-9F, 3.5F, -10F);

		bodyModel[73].addBox(0F, 0F, 0F, 4, 0, 1, 0F); // Box 142
		bodyModel[73].setRotationPoint(-13F, 8F, -8.5F);

		bodyModel[74].addBox(0F, 0F, 0F, 7, 1, 0, 0F); // Box 143
		bodyModel[74].setRotationPoint(2F, 6.5F, -8F);

		bodyModel[75].addBox(0F, 0F, 0F, 7, 1, 0, 0F); // Box 144
		bodyModel[75].setRotationPoint(-9F, 6.5F, -8F);

		bodyModel[76].addBox(0F, 0F, 0F, 4, 0, 1, 0F); // Box 145
		bodyModel[76].setRotationPoint(-2F, 8F, -8.5F);

		bodyModel[77].addBox(0F, 0F, 0F, 4, 0, 1, 0F); // Box 146
		bodyModel[77].setRotationPoint(9F, 8F, -8.5F);
		...
		bodyModel[78].setRotationPoint(-3F, 4F, -8.5F);
		...
		bodyModel[79].setRotationPoint(-14F, 4F, -8.5F);
		...
		bodyModel[80].setRotationPoint(8F, 4F, -8.5F);
		...
		bodyModel[81].setRotationPoint(-0.5F, 3.5F, -9F);
		...
		bodyModel[82].setRotationPoint(16F, 4F, -9F);
		...
		bodyModel[84].setRotationPoint(16F, 4F, -7F);
		...
		bodyModel[85].setRotationPoint(16F, 4F, 5F);

		bodyModel[86].addBox(0F, 0F, 0F, 1, 2, 10, 0F); // Box 155
		bodyModel[86].setRotationPoint(16F, 5F, -5F);

		bodyModel[87].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 156
		bodyModel[87].setRotationPoint(-8F, 7.5F, 8F);

		bodyModel[88].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 157
		bodyModel[88].setRotationPoint(4F, 7.5F, 8F);

		bodyModel[89].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 158
		bodyModel[89].setRotationPoint(4F, 7.5F, -8F);

		bodyModel[90].addBox(0F, 0F, 0F, 4, 1, 0, 0F); // Box 159
		bodyModel[90].setRotationPoint(-8F, 7.5F, -8F);
		...
		bodyModel[91].setRotationPoint(-8F, 3F, -9F);
		...
		bodyModel[92].setRotationPoint(-8F, 3F, 8F);
		...
		bodyModel[93].setRotationPoint(5F, 3F, -9F);
		...
		bodyModel[94].setRotationPoint(5F, 3F, 8F);
	}
}