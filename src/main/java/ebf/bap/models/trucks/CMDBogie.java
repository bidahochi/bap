...
public class CMDBogie extends ModelBase
{
	...
	public CMDBogie()
	{
		...
		bodyModel[2] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[3] = new ModelRendererTurbo(this, 9, 9, textureX, textureY); // Axel1
		bodyModel[4] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[5] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[6] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[7] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[8] = new ModelRendererTurbo(this, 0, 10, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[9] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[10] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[11] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[12] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[13] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[14] = new ModelRendererTurbo(this, 0, 10, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		...
		bodyModel[23] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[24] = new ModelRendererTurbo(this, 0, 10, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[25] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[26] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[27] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[28] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[29] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[30] = new ModelRendererTurbo(this, 0, 10, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[31] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[32] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[33] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
		bodyModel[34] = new ModelRendererTurbo(this, 0, 0, textureX, textureY, StaticModelAnimator.tagWheel); // Wheel
