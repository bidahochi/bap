...
public class ModelEF1_driver_back extends ModelConverter//Same as Filename
{
	int textureX = 128;
	int textureY = 128;

	public ModelEF1_driver_back() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[53] = new ModelRendererTurbo(this, 25, 57, textureX, textureY, StaticModelAnimator.tagWheel); // Box 187 wheel
		bodyModel[54] = new ModelRendererTurbo(this, 65, 57, textureX, textureY, StaticModelAnimator.tagWheel); // Box 188 wheel
		...
		bodyModel[96] = new ModelRendererTurbo(this, 41, 113, textureX, textureY, StaticModelAnimator.tagWheel); // Box 189 wheel
		bodyModel[97] = new ModelRendererTurbo(this, 65, 113, textureX, textureY, StaticModelAnimator.tagWheel); // Box 190 wheel
