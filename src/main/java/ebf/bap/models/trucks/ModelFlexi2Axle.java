...
public class ModelFlexi2Axle extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelFlexi2Axle() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[3] = new ModelRendererTurbo(this, 25, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 46
		bodyModel[4] = new ModelRendererTurbo(this, 41, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 47
		bodyModel[5] = new ModelRendererTurbo(this, 73, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 48
		...
		bodyModel[65] = new ModelRendererTurbo(this, 265, 9, textureX, textureY); // Box 71
		bodyModel[66] = new ModelRendererTurbo(this, 305, 9, textureX, textureY); // Box 72
		bodyModel[67] = new ModelRendererTurbo(this, 337, 9, textureX, textureY); // Box 73
		bodyModel[68] = new ModelRendererTurbo(this, 377, 9, textureX, textureY); // Box 74
		bodyModel[69] = new ModelRendererTurbo(this, 297, 9, textureX, textureY); // Box 153
		bodyModel[70] = new ModelRendererTurbo(this, 305, 9, textureX, textureY); // Box 154
		...
		bodyModel[10].setRotationPoint(-6F, 3.5F, -8.5F);
		...
		bodyModel[11].setRotationPoint(-6F, 5.5F, -8.25F);
		...
		bodyModel[12].setRotationPoint(-10F, 5.5F, -8.25F);
		...
		bodyModel[13].setRotationPoint(8F, 5.5F, -8.25F);
		...
		bodyModel[14].setRotationPoint(4F, 5.5F, -8.25F);
		...
		bodyModel[15].setRotationPoint(-6F, 5.5F, -8.5F);
		...
		bodyModel[16].setRotationPoint(3F, 5.5F, -8.5F);

		bodyModel[17].addBox(0F, 0F, 0F, 6, 2, 1, 0F); // Box 17
		bodyModel[17].setRotationPoint(-3F, 5.5F, -8.5F);

		bodyModel[18].addBox(0F, 0F, 0F, 9, 0, 1, 0F); // Box 177
		bodyModel[18].setRotationPoint(-11.5F, 8.51F, -8.25F);
		...
		bodyModel[19].setRotationPoint(-11F, 5.51F, -8.25F);
		...
		bodyModel[21].setRotationPoint(-8F, 3.5F, -8F);
		...
		bodyModel[22].setRotationPoint(-10F, 3.5F, -8F);
		...
		bodyModel[23].setRotationPoint(8F, 3.5F, -8F);
		...
		bodyModel[24].setRotationPoint(6F, 3.5F, -8.5F);

		bodyModel[25].addBox(0F, 0F, 0F, 9, 0, 1, 0F); // Box 27
		bodyModel[25].setRotationPoint(2.5F, 8.51F, -8.25F);
		...
		bodyModel[27].setRotationPoint(11F, 5.51F, -8.25F);
		...
		bodyModel[28].setRotationPoint(10F, 4F, -8F);
		...
		bodyModel[29].setRotationPoint(-10F, 3.5F, -9.5F);

		bodyModel[30].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 52
		bodyModel[30].setRotationPoint(-8F, 4.4F, -9.5F);
		...
		bodyModel[31].setRotationPoint(-6F, 4.4F, -9.5F);
		...
		bodyModel[32].setRotationPoint(8F, 3.5F, -9.5F);

		bodyModel[33].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 39
		bodyModel[33].setRotationPoint(6F, 4.4F, -9.5F);
		...
		bodyModel[34].setRotationPoint(3F, 4.4F, -9.5F);

		bodyModel[35].addBox(0F, 0F, 0F, 0, 2, 1, 0F); // Box 41
		bodyModel[35].setRotationPoint(-3F, 6.5F, -8.25F);

		bodyModel[36].addBox(0F, 0F, 0F, 0, 2, 1, 0F); // Box 42
		bodyModel[36].setRotationPoint(3F, 6.5F, -8.25F);

		bodyModel[37].addBox(0F, 0F, 0F, 6, 2, 1, 0F); // Box 43
		bodyModel[37].setRotationPoint(-3F, 5.5F, 7.5F);
		...
		bodyModel[38].setRotationPoint(3F, 5.5F, 7.5F);
		...
		bodyModel[39].setRotationPoint(-6F, 5.5F, 7.5F);
		...
		bodyModel[40].setRotationPoint(-6F, 3.5F, 7.5F);
		...
		bodyModel[41].setRotationPoint(6F, 3.5F, 7.5F);
		...
		bodyModel[43].setRotationPoint(-8F, 3.5F, 7F);
		...
		bodyModel[44].setRotationPoint(-10F, 3.5F, 7F);
		...
		bodyModel[45].setRotationPoint(-11F, 4F, 7F);
		...
		bodyModel[47].setRotationPoint(-10F, 5.5F, 7.25F);
		...
		bodyModel[48].setRotationPoint(-6F, 5.5F, 7.25F);
		...
		bodyModel[49].setRotationPoint(4F, 5.5F, 7.25F);
		...
		bodyModel[50].setRotationPoint(8F, 5.5F, 7.25F);

		bodyModel[51].addBox(0F, 0F, 0F, 0, 2, 1, 0F); // Box 57
		bodyModel[51].setRotationPoint(3F, 6.5F, 7.25F);

		bodyModel[52].addBox(0F, 0F, 0F, 9, 0, 1, 0F); // Box 58
		bodyModel[52].setRotationPoint(2.5F, 8.51F, 7.25F);
		...
		bodyModel[53].setRotationPoint(11F, 5.51F, 7.25F);

		bodyModel[54].addBox(0F, 0F, 0F, 0, 2, 1, 0F); // Box 60
		bodyModel[54].setRotationPoint(-3F, 6.5F, 7.25F);

		bodyModel[55].addBox(0F, 0F, 0F, 9, 0, 1, 0F); // Box 61
		bodyModel[55].setRotationPoint(-11.5F, 8.51F, 7.25F);
		...
		bodyModel[56].setRotationPoint(-11F, 5.51F, 7.25F);
		...
		bodyModel[57].setRotationPoint(-2F, 7F, 7F);
		...
		bodyModel[58].setRotationPoint(-6F, 4.4F, 8.5F);
		...
		bodyModel[59].setRotationPoint(8F, 3.5F, 8.5F);

		bodyModel[60].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 66
		bodyModel[60].setRotationPoint(6F, 4.4F, 8.5F);
		...
		bodyModel[61].setRotationPoint(3F, 4.4F, 8.5F);

		bodyModel[62].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 68
		bodyModel[62].setRotationPoint(-8F, 4.4F, 8.5F);
		...
		bodyModel[63].setRotationPoint(-10F, 3.5F, 8.5F);

		bodyModel[64].addBox(0F, 0F, 0F, 22, 0, 2, 0F); // Box 70
		bodyModel[64].setRotationPoint(-11F, 4.5F, -9F);
		bodyModel[64].rotateAngleX = 0.87266463F;

		bodyModel[65].addBox(0F, 0F, 0F, 7, 4, 11, 0F); // Box 71
		bodyModel[65].setRotationPoint(-10F, 4.5F, -5.5F);

		bodyModel[66].addBox(0F, 0F, 0F, 7, 4, 11, 0F); // Box 72
		bodyModel[66].setRotationPoint(3F, 4.5F, -5.5F);

		bodyModel[67].addBox(0F, 0F, -2F, 22, 0, 2, 0F); // Box 73
		bodyModel[67].setRotationPoint(-11F, 4.5F, 9F);
		bodyModel[67].rotateAngleX = -0.87266463F;

		bodyModel[68].addBox(0F, 0F, 0F, 6, 4, 14, 0F); // Box 74
		bodyModel[68].setRotationPoint(-3F, 4.5F, -7F);

		bodyModel[69].addBox(0F, 0F, 0F, 1, 1, 2, 0F); // Box 153
		bodyModel[69].setRotationPoint(-3F, 4F, -1F);

		bodyModel[70].addBox(0F, 0F, 0F, 1, 1, 2, 0F); // Box 154
		bodyModel[70].setRotationPoint(2F, 4F, -1F);
	}
}