...
public class Model41_N_11_truck extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public Model41_N_11_truck() //Same as Filename
	{
	...
	{
		bodyModel[0] = new ModelRendererTurbo(this, 1, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 2 wheel
		bodyModel[1] = new ModelRendererTurbo(this, 17, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 2 wheel
		...
		bodyModel[6] = new ModelRendererTurbo(this, 65, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 2 wheel
		...
		bodyModel[66] = new ModelRendererTurbo(this, 129, 9, textureX, textureY, StaticModelAnimator.tagWheel); // Box 2 wheel
