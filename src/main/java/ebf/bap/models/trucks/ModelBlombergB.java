...
public class ModelBlombergB extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[6] = new ModelRendererTurbo(this, 41, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 46 wheel
		bodyModel[7] = new ModelRendererTurbo(this, 73, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 47 wheel
		bodyModel[8] = new ModelRendererTurbo(this, 105, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 48 wheel
		...
		bodyModel[4].setRotationPoint(-3.5F, 4.5F, -8F);
		...
		bodyModel[8].setRotationPoint(7F, 7F, -6F);

		bodyModel[9].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 63
		bodyModel[9].setRotationPoint(5.5F, 9.01F, -8.5F);

		bodyModel[10].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 69
		bodyModel[10].setRotationPoint(-8.5F, 9.01F, -8.5F);
		...
		bodyModel[11].setRotationPoint(-11.5F, 4F, -8.5F);
		...
		bodyModel[12].setRotationPoint(-11.5F, 5F, -4.5F);
		...
		bodyModel[14].setRotationPoint(-11.5F, 4F, 3.5F);
		...
		bodyModel[15].setRotationPoint(10.5F, 4F, -8.5F);
		...
		bodyModel[16].setRotationPoint(10.5F, 4F, 3.5F);
		...
		bodyModel[17].setRotationPoint(10.5F, 5F, -4.5F);
		...
		bodyModel[18].setRotationPoint(10.5F, 4F, -4.5F);
		...
		bodyModel[19].setRotationPoint(-11.5F, 4F, 4.5F);
		...
		bodyModel[20].setRotationPoint(10.5F, 4F, 4.5F);

		bodyModel[21].addBox(0F, 0F, 0F, 7, 3, 11, 0F); // Box 122
		bodyModel[21].setRotationPoint(-9F, 5.5F, -5.5F);

		bodyModel[22].addBox(0F, 0F, 0F, 7, 3, 11, 0F); // Box 123
		bodyModel[22].setRotationPoint(2F, 5.5F, -5.5F);
		...
		bodyModel[24].setRotationPoint(-10.5F, 4F, -8.5F);
		...
		bodyModel[26].setRotationPoint(-2.5F, 5F, -8.5F);

		bodyModel[27].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 89
		bodyModel[27].setRotationPoint(-8F, 5F, -8.5F);

		bodyModel[28].addBox(0F, 0F, 0F, 8, 1, 0, 0F); // Box 91
		bodyModel[28].setRotationPoint(-10.5F, 8F, -7.5F);

		bodyModel[29].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 92
		bodyModel[29].setRotationPoint(4F, 5F, -8.5F);
		...
		bodyModel[30].setRotationPoint(-3.5F, 7.5F, -8F);
		...
		bodyModel[31].setRotationPoint(2.5F, 4.5F, -8F);
		...
		bodyModel[32].setRotationPoint(2.5F, 7.5F, -8F);
		...
		bodyModel[34].setRotationPoint(-2.5F, 3.75F, -8.75F);

		bodyModel[35].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 103
		bodyModel[35].setRotationPoint(1.5F, 3.75F, -8.75F);
		...
		bodyModel[36].setRotationPoint(-8F, 6F, -9.5F);
		...
		bodyModel[37].setRotationPoint(6F, 6F, -9.5F);
		...
		bodyModel[38].setRotationPoint(-10F, 3F, -8.5F);
		...
		bodyModel[39].setRotationPoint(4F, 3F, -8.5F);
		...
		bodyModel[40].setRotationPoint(-10F, 5F, -8.5F);

		bodyModel[41].addBox(0F, 0F, 0F, 21, 1, 1, 0F); // Box 114
		bodyModel[41].setRotationPoint(-10.5F, 4F, 7.5F);

		bodyModel[42].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 116
		bodyModel[42].setRotationPoint(-8F, 5F, 7.5F);
		...
		bodyModel[43].setRotationPoint(-10F, 5F, 7.5F);
		...
		bodyModel[45].setRotationPoint(4F, 5F, 7.5F);
		...
		bodyModel[46].setRotationPoint(8F, 5F, 7.5F);

		bodyModel[47].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 124
		bodyModel[47].setRotationPoint(5.5F, 9.01F, 7.5F);

		bodyModel[48].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 125
		bodyModel[48].setRotationPoint(-8.5F, 9.01F, 7.5F);
		...
		bodyModel[49].setRotationPoint(4F, 3F, 7.5F);
		...
		bodyModel[51].setRotationPoint(-10F, 3F, 7.5F);

		bodyModel[52].addBox(0F, 0F, 0F, 8, 1, 0, 0F); // Box 129
		bodyModel[52].setRotationPoint(2.5F, 8F, 7.5F);

		bodyModel[53].addBox(0F, 0F, 0F, 8, 1, 0, 0F); // Box 130
		bodyModel[53].setRotationPoint(-10.5F, 8F, 7.5F);

		bodyModel[54].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 60
		bodyModel[54].setRotationPoint(4F, 3.5F, 8.5F);
		...
		bodyModel[55].setRotationPoint(3F, 3.5F, 5.5F);

		bodyModel[56].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 62
		bodyModel[56].setRotationPoint(5.5F, 3.05F, 8.5F);
		...
		bodyModel[57].setRotationPoint(-4F, 3.5F, 5.5F);

		bodyModel[58].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 145
		bodyModel[58].setRotationPoint(-6F, 3.5F, 8.5F);

		bodyModel[59].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 146
		bodyModel[59].setRotationPoint(-7.5F, 3.05F, 8.5F);

		bodyModel[60].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 147
		bodyModel[60].setRotationPoint(-6F, 3.5F, -9.5F);

		bodyModel[61].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 148
		bodyModel[61].setRotationPoint(5.5F, 3.05F, -9.5F);

		bodyModel[62].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 149
		bodyModel[62].setRotationPoint(4F, 3.5F, -9.5F);
		...
		bodyModel[63].setRotationPoint(3F, 3.5F, -9.5F);
		...
		bodyModel[64].setRotationPoint(-4F, 3.5F, -9.5F);

		bodyModel[65].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 152
		bodyModel[65].setRotationPoint(-7.5F, 3.05F, -9.5F);
		...
		bodyModel[66].setRotationPoint(2.5F, 4.5F, 7F);
		...
		bodyModel[67].setRotationPoint(2.5F, 7.5F, 7F);
		...
		bodyModel[68].setRotationPoint(-3.5F, 4.5F, 7F);
		...
		bodyModel[69].setRotationPoint(-3.5F, 7.5F, 7F);

		bodyModel[70].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 161
		bodyModel[70].setRotationPoint(-2.5F, 3.75F, 7.75F);

		bodyModel[71].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 162
		bodyModel[71].setRotationPoint(1.5F, 3.75F, 7.75F);
		...
		bodyModel[72].setRotationPoint(6.5F, 3.75F, -9F);
		...
		bodyModel[73].setRotationPoint(6.5F, 3.75F, 9F);
		...
		bodyModel[74].setRotationPoint(6F, 6F, 8.5F);
		...
		bodyModel[75].setRotationPoint(-8F, 6F, 8.5F);
		...
		bodyModel[76].setRotationPoint(-2F, 6F, -8F);
		...
		bodyModel[77].setRotationPoint(-2F, 7.5F, -8F);
		...
		bodyModel[78].setRotationPoint(-2F, 6F, 6F);
		...
		bodyModel[79].setRotationPoint(-2F, 7.5F, 6F);
		...
		bodyModel[80].setRotationPoint(-2F, 7.1F, -9F);
		...
		bodyModel[81].setRotationPoint(-2F, 6.4F, -9F);
		...
		bodyModel[82].setRotationPoint(-2F, 6.75F, -10F);
		...
		bodyModel[83].setRotationPoint(-2F, 7.1F, 6F);
		...
		bodyModel[84].setRotationPoint(-2F, 6.4F, 6F);
		...
		bodyModel[85].setRotationPoint(-2F, 6.75F, 7F);
		...
		bodyModel[86].setRotationPoint(-2.25F, 5.25F, -6F);
		...
		bodyModel[87].setRotationPoint(-2.25F, 8.5F, -9.5F);
		...
		bodyModel[88].setRotationPoint(-2.75F, 4F, -9F);
		...
		bodyModel[90].setRotationPoint(-2.25F, 8.5F, 8.5F);
		...
		bodyModel[91].setRotationPoint(1.25F, 4F, 8F);
		...
		bodyModel[92].setRotationPoint(-2.75F, 4F, 8F);
		...
		bodyModel[93].setRotationPoint(-6F, 6F, -8.5F);
		...
		bodyModel[94].setRotationPoint(-4F, 5.5F, -8.5F);
		...
		bodyModel[95].setRotationPoint(-6F, 6F, -8.5F);
		...
		bodyModel[96].setRotationPoint(2F, 5.5F, -8.5F);
		...
		bodyModel[97].setRotationPoint(4F, 6F, -8.5F);
		...
		bodyModel[98].setRotationPoint(4F, 6F, -8.5F);
		...
		bodyModel[99].setRotationPoint(4F, 6F, 7.5F);
		...
		bodyModel[100].setRotationPoint(4F, 6F, 7.5F);
		...
		bodyModel[101].setRotationPoint(2F, 5.5F, 7.5F);
		...
		bodyModel[102].setRotationPoint(-4F, 5.5F, 7.5F);
		...
		bodyModel[103].setRotationPoint(-6F, 6F, 7.5F);
		...
		bodyModel[104].setRotationPoint(-6F, 6F, 7.5F);
	}
}