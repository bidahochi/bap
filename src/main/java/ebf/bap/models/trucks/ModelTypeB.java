...
public class ModelTypeB extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[2] = new ModelRendererTurbo(this, 1, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 30
		...
		bodyModel[16] = new ModelRendererTurbo(this, 161, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 46
		bodyModel[17] = new ModelRendererTurbo(this, 193, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 47
		bodyModel[18] = new ModelRendererTurbo(this, 209, 1, textureX, textureY, StaticModelAnimator.tagWheel); // Box 48
		...
		bodyModel[17].setRotationPoint(-8F, 7F, -6F);
		...
		bodyModel[20].setRotationPoint(-5.5F, 7.5F, -8.75F);
		...
		bodyModel[21].setRotationPoint(-7F, 8.5F, -8.75F);
		...
		bodyModel[22].setRotationPoint(-11F, 3F, -8.5F);

		bodyModel[23].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 52
		bodyModel[23].setRotationPoint(-9F, 3.9F, -8.5F);
		...
		bodyModel[24].setRotationPoint(-7F, 3.9F, -8.5F);

		bodyModel[25].addBox(0F, 0F, 0F, 7, 0, 1, 0F); // Box 63
		bodyModel[25].setRotationPoint(4.5F, 8.51F, -7.5F);

		bodyModel[26].addBox(0F, 0F, 0F, 0, 3, 1, 0F); // Box 64
		bodyModel[26].setRotationPoint(11.5F, 5.51F, -7.5F);

		bodyModel[27].addBox(0F, 0F, 0F, 7, 0, 1, 0F); // Box 69
		bodyModel[27].setRotationPoint(-11.5F, 8.51F, -7.5F);

		bodyModel[28].addBox(0F, 0F, 0F, 0, 3, 1, 0F); // Box 70
		bodyModel[28].setRotationPoint(-11.5F, 5.51F, -7.5F);
		...
		bodyModel[29].setRotationPoint(-12F, 4F, -6.5F);
		...
		bodyModel[30].setRotationPoint(-12F, 4F, 3.5F);
		...
		bodyModel[31].setRotationPoint(-12F, 5F, -3.5F);
		...
		bodyModel[32].setRotationPoint(-12F, 4F, -3.5F);
		...
		bodyModel[33].setRotationPoint(-12F, 4F, 2.5F);
		...
		bodyModel[34].setRotationPoint(11F, 4F, -6.5F);
		...
		bodyModel[35].setRotationPoint(11F, 4F, 3.5F);
		...
		bodyModel[36].setRotationPoint(11F, 4F, 2.5F);
		...
		bodyModel[37].setRotationPoint(11F, 5F, -3.5F);
		...
		bodyModel[38].setRotationPoint(11F, 4F, -3.5F);
		...
		bodyModel[39].setRotationPoint(-9F, 5F, -8.75F);
		...
		bodyModel[40].setRotationPoint(3F, 4F, -7.75F);
		...
		bodyModel[41].setRotationPoint(-12F, 4F, -7.75F);
		...
		bodyModel[42].setRotationPoint(-5F, 4F, -7.75F);
		...
		bodyModel[43].setRotationPoint(-3F, 4F, -8.25F);
		...
		bodyModel[44].setRotationPoint(-9F, 6F, -9.5F);
		...
		bodyModel[45].setRotationPoint(7F, 6F, -9.5F);
		...
		bodyModel[46].setRotationPoint(6F, 8.5F, -8.75F);
		...
		bodyModel[47].setRotationPoint(6F, 6F, -8.75F);
		...
		bodyModel[48].setRotationPoint(6F, 5F, -8.75F);
		...
		bodyModel[49].setRotationPoint(6F, 4.5F, -8.75F);
		...
		bodyModel[50].setRotationPoint(-1.5F, 5.5F, -8F);
		...
		bodyModel[51].setRotationPoint(-1.5F, 7F, -8F);
		...
		bodyModel[52].setRotationPoint(-1.5F, 6.6F, -9F);
		...
		bodyModel[53].setRotationPoint(-1.5F, 5.9F, -9F);
		...
		bodyModel[54].setRotationPoint(-1.5F, 6.25F, -10F);

		bodyModel[55].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 219
		bodyModel[55].setRotationPoint(7F, 3.9F, -8.5F);
		...
		bodyModel[56].setRotationPoint(4F, 3.9F, -8.5F);
		...
		bodyModel[57].setRotationPoint(9F, 3F, -8.5F);
		...
		bodyModel[58].setRotationPoint(6F, 5F, 7.75F);
		...
		bodyModel[59].setRotationPoint(6F, 4.5F, 7.75F);
		...
		bodyModel[60].setRotationPoint(6F, 6F, 7.75F);
		...
		bodyModel[61].setRotationPoint(6F, 8.5F, 7.75F);

		bodyModel[62].addBox(0F, 0F, 0F, 11, 2, 1, 0F); // Box 333
		bodyModel[62].setRotationPoint(-5.5F, 7.5F, 7.75F);
		...
		bodyModel[63].setRotationPoint(-7F, 8.5F, 7.75F);
		...
		bodyModel[64].setRotationPoint(-7F, 6F, 7.75F);
		...
		bodyModel[65].setRotationPoint(-9F, 5F, 7.75F);
		...
		bodyModel[66].setRotationPoint(-9F, 4.5F, 7.75F);
		...
		bodyModel[67].setRotationPoint(9F, 3F, 7.5F);
		...
		bodyModel[70].setRotationPoint(-11F, 3F, 7.5F);

		bodyModel[71].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 342
		bodyModel[71].setRotationPoint(-9F, 3.9F, 7.5F);
		...
		bodyModel[72].setRotationPoint(-7F, 3.9F, 7.5F);

		bodyModel[73].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 344
		bodyModel[73].setRotationPoint(7F, 3.9F, 7.5F);
		...
		bodyModel[74].setRotationPoint(4F, 3.9F, 7.5F);
		...
		bodyModel[75].setRotationPoint(5F, 4F, 6.75F);
		...
		bodyModel[76].setRotationPoint(9F, 5.5F, 6.75F);
		...
		bodyModel[77].setRotationPoint(5F, 5.5F, 6.75F);
		...
		bodyModel[78].setRotationPoint(-7F, 5.5F, 6.75F);
		...
		bodyModel[79].setRotationPoint(-11F, 5.5F, 6.75F);
		...
		bodyModel[80].setRotationPoint(-12F, 4F, 6.75F);
		...
		bodyModel[81].setRotationPoint(-5F, 4F, 6.75F);
		...
		bodyModel[82].setRotationPoint(-3F, 4F, 7.25F);
		...
		bodyModel[83].setRotationPoint(3F, 4F, 6.75F);
		...
		bodyModel[84].setRotationPoint(-1.5F, 5.5F, 6F);
		...
		bodyModel[85].setRotationPoint(-1.5F, 7F, 6F);
		...
		bodyModel[86].setRotationPoint(-1.5F, 6.6F, 6F);
		...
		bodyModel[87].setRotationPoint(-1.5F, 5.9F, 6F);
		...
		bodyModel[88].setRotationPoint(-1.5F, 6.25F, 7F);

		bodyModel[89].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 365
		bodyModel[89].setRotationPoint(-3.5F, 5.5F, 7F);

		bodyModel[90].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 366
		bodyModel[90].setRotationPoint(4F, 5.5F, 7F);

		bodyModel[91].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 367
		bodyModel[91].setRotationPoint(2.5F, 5.5F, 7F);

		bodyModel[92].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 368
		bodyModel[92].setRotationPoint(-5F, 5.5F, 7F);

		bodyModel[93].addBox(0F, 0F, 0F, 6, 5, 11, 0F); // Box 369
		bodyModel[93].setRotationPoint(4.5F, 4F, -5.5F);

		bodyModel[94].addBox(0F, 0F, 0F, 3, 4, 13, 0F); // Box 370
		bodyModel[94].setRotationPoint(-4.5F, 5F, -6.5F);

		bodyModel[95].addBox(0F, 0F, 0F, 3, 4, 13, 0F); // Box 371
		bodyModel[95].setRotationPoint(1.5F, 5F, -6.5F);
		...
		bodyModel[96].setRotationPoint(-1F, 4F, -1F);

		bodyModel[97].addBox(0F, 0F, 0F, 7, 0, 1, 0F); // Box 175
		bodyModel[97].setRotationPoint(-11.5F, 8.51F, 6.5F);

		bodyModel[98].addBox(0F, 0F, 0F, 0, 3, 1, 0F); // Box 176
		bodyModel[98].setRotationPoint(-11.5F, 5.51F, 6.5F);

		bodyModel[99].addBox(0F, 0F, 0F, 7, 0, 1, 0F); // Box 177
		bodyModel[99].setRotationPoint(4.5F, 8.51F, 6.5F);

		bodyModel[100].addBox(0F, 0F, 0F, 0, 3, 1, 0F); // Box 178
		bodyModel[100].setRotationPoint(11.5F, 5.51F, 6.5F);
	}
}