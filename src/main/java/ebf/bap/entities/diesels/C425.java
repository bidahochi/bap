...
public class C425 extends EntityTrainCore {

    public C425(World worldObj) {
        super(worldObj);
    }

    public C425(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }

    public static final Item thisItem = new ItemTransport(new C425((World)null), BAP.MODID, BAP.creativeTabDiesel);


    //main stats
    @Override
    public String transportName(){return "C425";}
    @Override
    public String transportcountry(){return "North America";}
    @Override
    public String transportYear(){return "1964-1966";}
    @Override
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),
                BAP.MODID,"textures/diesels/c425_PC.png","textures/bogies/typeb_Black.png","Penn Central", "description.c425.pc");
        SkinRegistry.addSkin(this.getClass(),
                BAP.MODID,"textures/diesels/c425_OWO22.png","textures/bogies/typeb_Grey.png","Washaska & Old Fox 22", "description.c425.owo");
    }
    @Override
    ...
    public Bogie[] bogies(){
        ...
        if(getCurrentSkin()==null || getCurrentSkin().name.equals("Washaska & Old Fox 22")) {//this doesnt really need to be the mutiple bogie model code,
