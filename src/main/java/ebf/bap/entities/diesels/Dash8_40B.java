...
public class Dash8_40B extends EntityTrainCore {

    public Dash8_40B(World worldObj) {
        super(worldObj);
    }

    public Dash8_40B(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }

    public static final Item thisItem = new ItemTransport(new Dash8_40B((World)null), BAP.MODID, BAP.creativeTabDiesel);

    //main stats
    @Override
    public String transportName(){return "Dash8-40B";}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
                BAP.MODID,"textures/diesels/dash8_40b_fox.png","textures/bogies/fb2_Grey.png","North Fox & Cascades", "description.b40-8.foxyboi");
    }
    @Override
    ...
    public Bogie[] bogies(){
        ...
        if(getCurrentSkin()==null || getCurrentSkin().name.equals("we use the word 'salad' and pretty photo-shopped pictures of " +
                "fruits and vegetables to trick you, in thinking our food is healthy, but, its really not!")) {
